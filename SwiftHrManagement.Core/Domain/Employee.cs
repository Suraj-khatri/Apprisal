...
namespace SwiftHrManagement.Core.Domain
{
    public class Employee :BaseDomain
    {
        ...
        {
            get { return subDepartment_id; }
            set { subDepartment_id = value; }
        }

        private string subDepartment_id2;

        public string SubDepartment_id2
        {
            get { return subDepartment_id2; }
            set { subDepartment_id2 = value; }
        }
        ...
        {
            get { return emRelationship; }
            set { emRelationship = value; }
        }
        private string emFirstContact;

        public string EmFirstContact
        {
            get { return emFirstContact; }
            set { emFirstContact = value; }
        }

        private string emSecondContact;

        public string EmSecondContact
        {
            get { return emSecondContact; }
            set { emSecondContact = value; }
        }

        private string emThirdContact;

        public string EmThirdContact
        {
            get { return emThirdContact; }
            set { emThirdContact = value; }
        }
        ...
        {
            get { return workingMonth; }
            set { workingMonth = value; }
        }
        private string leaveAuthority;

        public string LeaveAuthority
        {
            get { return leaveAuthority; }
            set { leaveAuthority = value; }
        }
        private string rLGroup;

        public string RLGroup
        {
            get { return rLGroup; }
            set { rLGroup = value; }
        }

        public string IndividualProfileUpdate
        {
            get { return _individualProfileUpdate; }
            set { _individualProfileUpdate = value; }
        }

        private string _individualProfileUpdate;
        private string permanentDate;

        public string PermanentDate
        {
        ...
        {
            get { return contractFrom; }
            set { contractFrom = value; }
        }
        private string contractTo;

        public string ContractTo
        {
            get { return contractTo; }
            set { contractTo = value; }
        }
        ...
        private string gratuityStartDate;

        public string GratuityStartDate
        {
            get { return gratuityStartDate; }
            set { gratuityStartDate = value; }
        }
        private string salaryTitle;

        public string SalaryTitle
        {
            get { return salaryTitle; }
            set { salaryTitle = value; }
        }
        ...
        public string LastPromoted
        {
            get { return lastpromoted; }
            set { lastpromoted = value; }
        }
