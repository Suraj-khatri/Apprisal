    ...
    public partial class List :BasePage
    {
        ...
        private void init()
        {
            ...
            String[,] matfilter = new String[,]{
                        {"log_type",                                 "Log Type",                "LT"},
                        {"table_name",                               "Table Name",              "LT"},
                        {"created_by",                               "User",                    "LT"},
                        {"created_date",                            " Date",                    "ED"},
                    
                    };

            //column type : T = text , M = Money, D = date , I = image
            String[,] matgrid = new String[,]{ 
                {"log_type",                     "Log Type",                   "200",      "T"},        
                {"table_name",                   "Table Name",                 "200",      "T"},
                {"created_by",                   "User",                       "200",      "T"},
                {"created_date",                 "Date",                       "200",      "D"},
            
                       
                        };

            string sortby = "created_date";
            string table_name = "applicationLogs";

            String sql = "";
            sql = "select rowId [Id],log_type,table_name,created_by,created_date from applicationLogs where 1=1";
        ...
        private string load_report(string table_name, string sql, String[,] matgrid, string[,] matfilter, String sortd, string sortby, int _page, int page_size)
        {
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                html.Append("<td class=\"text-center\"><a class=\"tool btn btn-primary btn-xs\"  data-toggle=\"tooltip\" data-placement=\"top\" title=\"View\" href=\"/ApplicationLogs/Manage.aspx?log_Id=" + dr["Id"] + "\"><i class=\"fa fa-eye\"></i></a></td>");
