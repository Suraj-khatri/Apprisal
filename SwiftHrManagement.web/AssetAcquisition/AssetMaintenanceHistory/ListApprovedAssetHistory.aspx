<%@ Page Language="C#" MasterPageFile="~/SwiftHRManager.Master" AutoEventWireup="true"
    CodeBehind="ListApprovedAssetHistory.aspx.cs" Inherits="SwiftHrManagement.web.AssetAcquisition.AssetMaintenanceHistory.ListApprovedAssetHistory" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainPlaceHolder" runat="server">
    <div class="panel">
        <header class="panel-heading">
         ...
         Approved Asset Maintenance History
        </header>
