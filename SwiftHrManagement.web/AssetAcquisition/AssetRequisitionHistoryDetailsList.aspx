<%@ Page Language="C#" MasterPageFile="~/SwiftHRManager.Master" AutoEventWireup="true"
    CodeBehind="AssetRequisitionHistoryDetailsList.aspx.cs" Inherits="SwiftHrManagement.web.AssetAcquisition.AssetRequisitionHistoryDetailsList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainPlaceHolder" runat="server">
    ...
    <div class="panel">
        <header class="panel-heading">
           ...
           Asset Requesition History Details
        </header>
