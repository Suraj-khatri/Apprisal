...
{
    public partial class UploadPremiumpaid : BasePage
    {
        ClsDAOInv _clsdao = null;
        public UploadPremiumpaid()
        {
        ...
        protected void BtnUpload_Click(object sender, EventArgs e)
        {
            ...
            string location_2_move = AttPath + "\\UploadFiles\\InsuranceBill\\";
        ...
        private void listFileInformation(DataTable dt)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                foreach (DataRow row in dt.Rows)
                {
                    ...
                    td3.Text = "<a target='_blank' href='/Billinformation/" + row["id"].ToString() + "." + row["file_type"].ToString() + "'>View</a>";
                    tr.Cells.Add(td1);
                    tr.Cells.Add(td2);
                    tr.Cells.Add(td3);
                    tblResult.Rows.Add(tr);
        ...
        {
            DataTable dt = _clsdao.getTable("exec proc_InsrBillFileUpload 's',@ROWID=" + GetBillId() + ",@mode='i'");
            return dt;
        }
        public string uploadFile(String fileName, string AttPath)
        {
            ...
            try
            {
                ...
                {
                    string saved_file_name = AttPath + "\\UploadFiles\\InsuranceBill\\" + strfilename;
        ...
        private string saveData(int Bill_Id, string FILE_DESC, string UPLOAD_BY, string FILE_TYPE)
        {
            ...
            p[7] = new SqlParameter("@jobflag", "i");
            //@jobflag
