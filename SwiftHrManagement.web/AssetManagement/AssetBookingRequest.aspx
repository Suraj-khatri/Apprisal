<%@ Page Language="C#" MasterPageFile="~/SwiftHRManager.Master" AutoEventWireup="true" CodeBehind="AssetBookingRequest.aspx.cs" Inherits="SwiftHrManagement.web.AssetManagement.AssetBookingRequest" %>
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <asp:DropDownList ID="vendorName" runat="server" 
                                CssClass="form-control" AutoPostBack="True" width="100%"> 
                            </asp:DropDownList>
                        </div>
                        <div class="col-md-6">
                            ...
                            <asp:TextBox ID="assettype" runat="server" 
                                CssClass="form-control" AutoComplete="off" width="100%"
                        ...
                        <div class="col-md-6">
                            ...
                            <asp:TextBox ID="billid" runat="server" 
                                CssClass="form-control" AutoComplete="off" width="100%"></asp:TextBox>
                  ...
                  <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <asp:TextBox ID="nextmaindate" runat="server" width="100%"
                                CssClass="form-control"></asp:TextBox>
                        ...
                        <div class="col-md-6">
                            ...
                            <asp:TextBox ID="TxtDepPct" runat="server" CssClass="form-control" width="100%"
                        ...
                        <div class="form-group">
                            <div class="col-md-6">
                                <asp:TextBox ID="txtLifeInMonth" runat="server" CssClass="form-control" width="100%"
                                    Visible="false" ontextchanged="txtLifeInMonth_TextChanged" AutoPostBack="true"></asp:TextBox>
                            </div>
                             <div class="col-md-6">
                                  <asp:TextBox ID="txtRemainLife" runat="server" CssClass="form-control" width="100%" Visible="false"></asp:TextBox><cc1:TextBoxWatermarkExtender ID="TextBoxWatermarkExtender1" 
                                        runat="server" Enabled="True" TargetControlID="txtLifeInMonth" 
                                        WatermarkCssClass="form-control" WatermarkText="Total Life In Month">
                                </cc1:TextBoxWatermarkExtender>
                                <cc1:TextBoxWatermarkExtender ID="TextBoxWatermarkExtender2" 
                                        runat="server" Enabled="True" TargetControlID="txtRemainLife" 
                                        WatermarkCssClass="form-control" WatermarkText="Remain Life In Month">
                                </cc1:TextBoxWatermarkExtender>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                              <div class="form-group">
                        <div class="col-md-6">
                            <label>Forwarded For Approval:<span class="errormsg">*</span></label>
                            <asp:DropDownList ID="ddlForward" runat="server" CssClass="form-control" width="100%"></asp:DropDownList>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                                ControlToValidate="ddlForward" Display="Dynamic" 
                                ErrorMessage="Required!" SetFocusOnError="True" 
                                ValidationGroup="book"></asp:RequiredFieldValidator> 
                        </div>
                        <div class="col-md-6">
                            <label>Rejection Reason:</label>
                            <asp:TextBox ID="rejectionReason" runat="server" CssClass="form-control" width="100%"
