<%@ Page Title="" Language="C#" MasterPageFile="~/SwiftHRManager.Master" AutoEventWireup="true" CodeBehind="ListApprove.aspx.cs" Inherits="SwiftHrManagement.web.AssetManagement.AssetMaintainenceStatus.ListApprove" %>
    ...
    <table width="100%">
        <tr>
            <td align="left" class="style1" valign="bottom">
                <img src="/Images/big_bullit.gif" />&nbsp;&nbsp;Asset Maintenance History</td>
        </tr>
        <tr>
