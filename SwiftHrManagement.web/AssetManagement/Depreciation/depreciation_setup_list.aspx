<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/SwiftHRManager.Master"
    CodeBehind="depreciation_setup_list.aspx.cs" Inherits="SwiftHrManagement.web.AssetManagement.Depreciation.depreciation_setup_list" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainPlaceHolder" runat="server">
    <div class="panel">
        <header class="panel-heading">
         ...
         Depreciation Setup for Current Fiscal Year
        </header>
        <div class="panel-body">
            <div class="row">
                    <section class="panel">
                        <div class="panel-body">
                             <div id="rpt" runat="server" class="branchlist"></div>
