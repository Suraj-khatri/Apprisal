<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/SwiftHRManager.Master"
    CodeBehind="ListRequestedAssetBooking.aspx.cs" Inherits="SwiftHrManagement.web.AssetManagement.ListRequestedAssetBooking" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript" language="javascript">
        ...
        function getDataExcel() {           
            document.getElementById("ctl00_MainPlaceHolder_Button1").click();
        }        
    </script>
</asp:Content>
