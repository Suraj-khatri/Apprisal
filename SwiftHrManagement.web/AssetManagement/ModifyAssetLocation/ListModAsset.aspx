<%@ Page Title="" Language="C#" MasterPageFile="~/SwiftHRManager.Master" AutoEventWireup="true" CodeBehind="ListModAsset.aspx.cs" Inherits="SwiftHrManagement.web.AssetManagement.ModifyAssetLocation.ListModAsset" %>
...
<%--<table width="100%">
                        <tr>
                            <td align="left" class="wellcome" valign="bottom">
                                <img src="/Images/big_bullit.gif" />&nbsp;Modify Asset List
                            </td>
                        </tr>
                        <tr>
