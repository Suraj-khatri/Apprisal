<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/SwiftHRManager.Master" CodeBehind="ViewAssetTransferRequest.aspx.cs" Inherits="SwiftHrManagement.web.AssetManagement.ViewAssetTransferRequest" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainPlaceHolder" runat="server">
    <div class="panel">
        <header class="panel-heading">
            ...
            Asset Transfer Request Details
        </header>
