...
namespace SwiftAssetManagement.AssetParameters
{
    public partial class AssetGrouping : BasePage
    {
        RoleMenuDAOInv _RoleMenuDAOInv = new RoleMenuDAOInv();
        ClsDAOInv _clsdao = null;
        public AssetGrouping()
        {
        ...
        {
            DataTable dt = _clsdao.getTable("exec [proc_ASSET_ITEMsetup] 'r'");
        ...
        {
            DataTable dt = _clsdao.getTable("exec  [proc_ASSET_ITEMsetup] 's',@parentid='" + parentid + "'");
        ...
        {
            string IsProduct = "";
            DataTable dt = _clsdao.getTable("exec  [proc_ASSET_ITEMsetup] 'c',@id='" + TvItem.SelectedNode.Value + "'");
            ...
            //TvItem.NodeStyle.ForeColor  = System.Drawing.Color.Yellow;
