...
#region SwiftGrid
        ...
        private void init()
        {
            ...
            String[,] matgrid = new String[,]{
                        ...
                        {"ID",       "ID",      "200",      "LT"},
                        {"FY_ID",       "Fiscal Year",      "200",      "LT"},
                        {"CREATEDDATE",        "Created Date",       "200",      "LT"}                        
                        };

            string sortby = "ID";
            string table_name = "DEPRECIATIONRULES";

            //String sql = " SELECT ID,FY_ID,CREATEDDATE FROM DEPRECIATIONRULES WHERE 1=1";

            String sql = "SELECT ID,FY_ID,CONVERT(VARCHAR,CREATEDDATE,107) AS CREATEDDATE FROM DEPRECIATIONRULES WHERE 1=1";
        ...
        private string load_report(string table_name, string sql, String[,] matgrid, string[,] matfilter, String sortd, string sortby, int _page, int page_size)
        {
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                html.Append("<td class=\"text-center\"><a class=\"tool btn btn-primary btn-xs\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"View\" href=\"/AssetParameters/DepreciationRules/Manage.aspx?id=" + dr["Id"] + "\"><i class=\"fa fa-eye\"></i></a></td>");
            ...
            string navigation_bar = get_paging_block(total_record, _page, page_size, true, "/AssetParameters/DepreciationRules/Manage.aspx");
