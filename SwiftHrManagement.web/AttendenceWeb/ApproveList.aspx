<%@ Page Title="" Language="C#" MasterPageFile="~/SwiftHRManager.Master" AutoEventWireup="true" CodeBehind="ApproveList.aspx.cs" Inherits="SwiftHrManagement.web.AttendenceWeb.ApproveList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainPlaceHolder" runat="server">
    ...
    <div class="panel">
        <header class="panel-heading">
         ...
         Approve Attendance Request Details
        </header>
