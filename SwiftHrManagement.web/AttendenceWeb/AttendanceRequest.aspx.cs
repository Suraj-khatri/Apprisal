...
{
    public partial class AttendanceRequest : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                if (_RoleMenuDAOInv.hasAccess(ReadSession().AdminId, 238) == false)
                {
        ...
        private void init()
        {
            ...
            String[,] matgrid = new String[,]{
                        ...
                        {"login_time",            "Actual Login",             "200",      "D"},
                        {"logout_time",       "Actual Logout",        "200",      "D"},
                        {"r_login_time",       "Requested Login",        "200",      "D"},
                        {"r_logout_time",       "Requested Logout",        "200",      "D"},
                        {"att_status",    "Status",     "200",      "T"},
            ...
            sql = @"SELECT A.id,emp_id,E.EMP_CODE,E.FIRST_NAME + ' ' + E.MIDDLE_NAME + ' ' + E.LAST_NAME AS EMP_NAME,
                        A.login_time,A.logout_time,r_login_time,r_logout_time,A.remarks,att_status
        ...
        private string load_report(string table_name, string sql, String[,] matgrid, string[,] matfilter, String sortd, string sortby, int _page, int page_size)
        {
            ...
            string thisPage = "AttendanceRequest.aspx?sortd=" + sortd + "&sortby={sortby}";
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                //html.Append("<td><a href=\"/AttendenceWeb/ManageRequest.aspx?Id=" + dr["id"] + "\">View</a></td>");
                html.Append("<td class=\"text-center\"><a class=\"tool btn btn-primary btn-xs\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"View\" href=\"/AttendenceWeb/ManageRequest.aspx?Id=" + dr["id"] + "\"><i class=\"fa fa-eye\"></i></a>");
            ...
            string navigation_bar = get_paging_block(total_record, _page, page_size, true, "/AttendenceWeb/ManageRequest.aspx");
