<%@ Page Title="" Language="C#" MasterPageFile="~/SwiftHRManager.Master" AutoEventWireup="true" CodeBehind="ListDetailLWP.aspx.cs" Inherits="SwiftHrManagement.web.AttendenceWeb.LWP.ListDetailLWP" %>
            ...
            <section class="panel">
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label>Employee Absent Detail</label>
