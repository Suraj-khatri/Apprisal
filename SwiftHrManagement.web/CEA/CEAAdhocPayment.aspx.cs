...
{
    public partial class CEAAdhocPayment : BasePage
    {
        RoleMenuDAOInv _roleMenuDao = null;
        clsDAO _clsDao = null;

        public CEAAdhocPayment()
        {
        ...
        private void init()
        {
            ...
            String sql = @"select cr.ID,rtrim(dbo.GetEmployeeFullNameOfId(Emp_ID)) Emp_ID ,convert(varchar,Bill_date,107) Bill_date
                            ...
                            WHERE cea_status = 'Approved' and 1=1";
        ...
        private string load_report(string table_name, string sql, String[,] matgrid, string[,] matfilter, String sortd, string sortby, int _page, int page_size)
        {
            ...
            string thisPage = "CEAAdhocPayment.aspx?sortd=" + sortd + "&sortby={sortby}";
        ...
        {
            _clsDao.runSQL("Exec [proc_CEA] @flag='p',@idlist='" + hdnID.Value + "'");
            init();
        }
