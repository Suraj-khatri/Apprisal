...
{
    public partial class ListAssignment : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                if (_RoleMenuDAOInv.hasAccess(ReadSession().AdminId, 249) == false)
                {
        ...
        private void init()
        {
            ...
            String[,] matgrid = new String[,]{
                            ...
                            {"No_of_Children",     "No of Children",    "200",      "T"},
                            {"StartDate",          "Start Date",        "200",      "T"},
                            {"Amount",             "Amount",            "200",      "M"}
                        };
            ...
            sql = @"select Id,rtrim(dbo.GetEmployeeFullNameOfId(Emp_ID)) Emp_ID,
                    Amount,convert(varchar, StartDate,107) StartDate, No_of_Children from CEA_Assignment WHERE 1=1";
