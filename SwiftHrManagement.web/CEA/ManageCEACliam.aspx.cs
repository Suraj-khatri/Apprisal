...
{
    public partial class ManageCEACliam : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                if (_RoleMenuDAOInv.hasAccess(ReadSession().AdminId, 251) == false || _RoleMenuDAOInv.hasAccess(ReadSession().AdminId, 254) == false)
                {
        ...
        {
            string type = "doc";
            string empid = getEmpIdfromInfo(lblEmployeeName.Text);
