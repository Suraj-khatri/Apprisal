...
{
    public partial class CMSMenuList : BasePage
    {
        ...
        private void init()
        {
            ...
            String[,] matfilter = new String[,]{  
                        {"CM.menu_name",    "Menu Name",         "LT"}                
                    };

            //column type : T = text , M = Money, D = date , I = image
            String[,] matgrid = new String[,]{
                        {"func_id",            "Page Name",             "200",      "T"},
                        {"menu_name",            "Menu",             "200",      "T"},
                        {"menu_desc",       "Menu Details",        "200",      "T"},
            ...
            string sortby = "id";
            string table_name = "CMS_Menu";

            String sql = "";

            sql = "select CM.id,CF.func_name AS func_id,CM.menu_name,CM.menu_desc,CM.linked_id,dbo.GetEmployeeFullNameOfId(CM.created_by) created_by,CM.create_date from CMS_Menu CM INNER JOIN CMS_functions CF ON CM.func_id=CF.id where 1=1";
        ...
        private string load_report(string table_name, string sql, String[,] matgrid, string[,] matfilter, String sortd, string sortby, int _page, int page_size)
        {
            ...
            string thisPage = "CMSMenuList.aspx?sortd=" + sortd + "&sortby={sortby}";
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                html.Append("<td class=\"text-center\"><a class=\"tool btn btn-primary btn-xs\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"View\" href=\"/CMS_Management/CMSMenuManage.aspx?ID=" + dr["id"] + "\"><i class=\"fa fa-eye\"></i></a></td>");
                html.Append("</tr>");
            }
            ...
            string navigation_bar = get_paging_block(total_record, _page, page_size, true, "/CMS_Management/CMSMenuManage.aspx");
