...
{
    public partial class ListPages : BasePage
    {
        ...
        private void init()
        {
            ...
            String[,] matfilter = new String[,]{                           
                        {"func_name",    "Page Name",         "LT"}                   
                    };

            //column type : T = text , M = Money, D = date , I = image
            String[,] matgrid = new String[,]{
                        {"func_name",            "Page Name",             "200",      "T"},
                        {"func_type",            "Page Type",             "200",      "T"},
                        {"create_by",       "Created By",        "200",      "T"},
            ...
            string sortby = "id";
            string table_name = "CMS_functions";

            String sql = "";

            sql = "SELECT id,func_type,func_name,created_date,dbo.GetEmployeeFullNameOfId(create_by) create_by,modify_by,modify_date from CMS_functions where 1=1";
        ...
        private string load_report(string table_name, string sql, String[,] matgrid, string[,] matfilter, String sortd, string sortby, int _page, int page_size)
        {
            ...
            string thisPage = "ListPages.aspx?sortd=" + sortd + "&sortby={sortby}";
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                html.Append("<td class=\"text-center\"><a class=\"tool btn btn-primary btn-xs\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"View\" href=\"/CMS_Management/ManagePages.aspx?ID=" + dr["id"] + "\"><i class=\"fa fa-eye\"></i></a></td>");
                html.Append("<td class=\"text-center\"><a class=\"tool btn btn-primary btn-xs\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Upload File\" href=\"/CMS_Management/UploadFile.aspx?ID=" + dr["id"] + "\"><i class=\"fa fa-file\"></i></a></td>");
                html.Append("</tr>");
            }
            ...
            string navigation_bar = get_paging_block(total_record, _page, page_size, true, "/CMS_Management/AddCmsPage.aspx");
