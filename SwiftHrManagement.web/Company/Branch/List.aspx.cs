    ...
    public partial class List : BasePage
    {
        ...
        private void init()
        {
            ...
            String[,] matfilter = new String[,]{  
                        ...
                        {"BRANCH_ADDRESS",    "Branch Address",         "LT"}                   
                    };

            //column type : T = text , M = Money, D = date , I = image
            String[,] matgrid = new String[,]{
                        {"BRANCH_NAME",            "Branch Name",             "200",      "T"},
                        {"BRANCH_SHORT_NAME",            "Branch Code",             "200",      "T"},
                        {"BRANCH_ADDRESS",            "Address",             "200",      "T"},
                        {"BRANCH_PHONE",       "Phone",        "200",      "T"},
                        {"CONTACT_PERSON",       "Contact Person",        "200",      "T"}
                        };



            string sortby = "BRANCH_ID";
        ...
        private string load_report(string table_name, string sql, String[,] matgrid, string[,] matfilter, String sortd, string sortby, int _page, int page_size)
        {
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                html.Append("<td class=\"text-center\"><a class=\"tool btn btn-primary btn-xs\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"View\" href=\"/Company/Branch/Manage.aspx?Id=" + Uri.EscapeUriString(StringEncryption.Encrypt(dr["BRANCH_ID"].ToString())) + "\"><i class=\"fa fa-eye\"></i></a></td>");
                html.Append("</tr>");
            }
            ...
            string navigation_bar = get_paging_block(total_record, _page, page_size, true, "/Company/Branch/Manage.aspx");
