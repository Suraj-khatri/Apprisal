<%@ Page Title="" Language="C#" MasterPageFile="~/Apprisal.Master" AutoEventWireup="true" CodeBehind="HRDJDList.aspx.cs" Inherits="SwiftHrManagement.web.Company.EmployeeWeb.JobDescription.HRDJDList" %>
        ...
        <div ng-controller="JdCtrl">
            ...
            <div class="panel panel-success">
                ...
                <div class="panel-heading">
                    <b>Admin Job Description List</b>
                ...
                <div class="panel-body  table-responsive table-bordered">
                    ...
                    <table class="table table-striped table-bordered table-responsive" style="overflow-x: scroll">
                            ...
                            <tr>
                                <td colspan="8">
                                    <div class="overlay" style="text-align: center">
                                        Loading... <i class="fa-5x fa fa-refresh fa-spin"></i>
                                    </div>
                                </td>
                            </tr>
                        ...
                        <tbody ng-show="loading">
                            <tr dir-paginate="item in JdHrdList|filter:{EmployeeName: EmpName,Sataus:status,FiscalYear:fiscal,SupervisorName:suv,Position:pos}|orderBy : 'Sn' :reverse| itemsPerPage:50">
