<%@ Page Title="" Language="C#" MasterPageFile="~/Apprisal.Master" AutoEventWireup="true" CodeBehind="JDList.aspx.cs" Inherits="SwiftHrManagement.web.Company.EmployeeWeb.JobDescription.JDList" %>
...
<%--<asp:Content ID="Content3" ContentPlaceHolderID="head" runat="server">
    ...
    {
        alert('H');
        var r = confirm("Are you sure you want to Delete this Job description ?");
        if (r == true) {
            $.ajax({
                url: 'JdList.aspx/Delete?id=' + id,
                method: "post",
    ...
    <script src="/Angular/Controller/JdCtrl.js"></script>
</asp:Content>
    ...
    <div ng-app="VoucherModule">
        <div ng-controller="JdCtrl">
            ...
            <div class="box box-warning direct-chat direct-chat-warning">
                ...
                <br />
                <div class="box-body">
                    <input type="hidden" ng-model="Search.status" value="List" />
                    ...
                    <%-- <div class="col-md-3 form-group">
                        ...
                        <select ng-model="Search.EmpId" class="form-control select" ng-options="item.Text for item in EmployeeList track by item.Value" required="required">
                ...
                <div class="panel-body  table-responsive table-bordered">
                    <table class="table table-striped table-bordered table-responsive" style="overflow-x: scroll">
                        ...
                        <thead>
                            ...
                            <tr>
                                <td>
                                    <input type="text" ng-model="EmpName" style="padding: 4px; border: 1px solid #808080; width: 100%" placeholder="Search Name" /></td>
                                <td></td>
                                <td></td>
                                <td></td>
                                <td></td>
                        ...
                        <tr dir-paginate="item in JobDescriptionList|filter:{EmployeeName: EmpName,Sataus:status}|orderBy : 'Sn' :reverse| itemsPerPage:50">
