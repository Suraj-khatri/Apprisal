<%@ Page Title="" Language="C#" MasterPageFile="~/ProjectMaster.Master" AutoEventWireup="true" CodeBehind="ListAdvanceCollection.aspx.cs" Inherits="SwiftHrManagement.web.Company.EmployeeWeb.ListAdvanceCollection" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainPlaceHolder" runat="server">
    <div class="panel">
        <header class="panel-heading">
            <i class="fa fa-caret-right"></i>   <a href="ListAdvance.aspx?Id=<%=GetEmpId().ToString()%>">List Advance  </a> &raquo; List Advance Deduction 
