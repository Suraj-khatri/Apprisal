<%@ Page Title="Swift HRM" Language="C#" MasterPageFile="~/ProjectMaster.Master" AutoEventWireup="true" CodeBehind="ListBankAccounts.aspx.cs" Inherits="SwiftHrManagement.web.Company.EmployeeWeb.ListBankAccounts" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainPlaceHolder" runat="server">
     <div class="panel">
        <header class="panel-heading">
           <i class="fa fa-caret-right"></i>    List Bank Account  
