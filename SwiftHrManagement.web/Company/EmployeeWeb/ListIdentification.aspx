<%@ Page Language="C#" MasterPageFile="~/ProjectMaster.Master" AutoEventWireup="true" CodeBehind="ListIdentification.aspx.cs" Inherits="SwiftHrManagement.web.Company.EmployeeWeb.ListIdentification" Title="Swift HRM" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainPlaceHolder" runat="server">
    <div class="panel">
        <header class="panel-heading">
            <i class="fa fa-caret-right"></i>   List Indentification 
