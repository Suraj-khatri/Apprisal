<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/SwiftHRManager.Master" CodeBehind="ListInsuranceForCreditDept.aspx.cs" Inherits="SwiftHrManagement.web.Company.EmployeeWeb.ListInsuranceForCreditDept" %>
...
<table width="100%">
        <tr>
            <td align="left" class="wellcome" valign="bottom">
                <img src="../../Images/big_bullit.gif" />&nbsp;&nbsp; Insurance For Credit Department
            </td>
        </tr>
        <tr>
