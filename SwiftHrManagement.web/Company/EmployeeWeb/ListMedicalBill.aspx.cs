...
{
    public partial class ListMedicalBill : BasePage
    {
        RoleMenuDAOInv _RoleMenuDAOInv = null;
        public ListMedicalBill()
        {
        ...
        private void init()
        {
            ...
            String[,] matgrid = new String[,]{ 
                        ...
                        {"BILL_AMOUNT",     "Bill Amount",  "200",      "T"},
                        {"STATUS",          "Status",       "200",      "T"}
                        };

            string sortby = "ID";
            string table_name = "MedicalBills";

            String sql = "";
            sql = " select ID,BILL_DATE,dbo.showdecimal(BILL_AMOUNT) BILL_AMOUNT, STATUS from MedicalBills where EMP_ID=" + GetEmpId() + "";
        ...
        private string load_report(string table_name, string sql, String[,] matgrid, string[,] matfilter, String sortd, string sortby, int _page, int page_size)
        {
            ...
            string thisPage = "ListMedicalBill.aspx?sortd=" + sortd + "&sortby={sortby}&Id=" + GetEmpId() + "";
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                html.Append("<td class=\"text-center\"><a class=\"tool btn btn-primary btn-xs\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"View\"  href=\"/Company/EmployeeWeb/ManageMedicalBill.aspx?Id=" + dr["ID"] + "&EmpId=" + GetEmpId() + "\"><i class=\"fa fa-eye\"></i></a></td>");
            }
            ...
            string navigation_bar = get_paging_block(total_record, _page, page_size, true, "/Company/EmployeeWeb/ManageMedicalBill.aspx?EmpId=" + GetEmpId() + "");
