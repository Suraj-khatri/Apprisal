<%@ Page Language="C#" MasterPageFile="~/projectMaster.Master" AutoEventWireup="true" CodeBehind="ListOtherInfo.aspx.cs" Inherits="SwiftHrManagement.web.Company.EmployeeWeb.ListOtherInfo" Title="Swift HRM" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainPlaceHolder" runat="server">
    <div class="panel">
        <header class="panel-heading">
           <i class="fa fa-caret-right"></i>    List Other Details For Tax 
