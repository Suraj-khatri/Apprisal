...
{
    public partial class ListOtherInfo : BasePage
    {
        RoleMenuDAOInv _RoleMenuDAOInv = null;  
        EmployeeDAO empDao = null;
        Employee empCore = null;
        public ListOtherInfo()
        {
        ...
        private void init()
        {
            ...
            String[,] matgrid = new String[,]{         
                        ...
                        {"WORKING_MONTH",        "Working Month",        "200",      "T"}, 
                        {"NATIONALITY",            "Is Nepali Residence",             "200",      "M"},
                        {"AVAAILED_VEHICLE_FACILITY",    "Vehicle Facility",     "200",      "T"}, 
                        {"AVAILED_HOUSE_RENT_FACILITY",    "House Facility",     "200",      "T"},
                        {"IS_PENSION_HOLDER",    "Pension Holder",     "200",      "D"},  
                        {"PENSION_AMOUNT",    "Annual Pension Amt",     "200",      "M"},  
                        {"IS_DISABLED",      "Differently Able",     "200",      "T"},
                        {"DISABLED_ID",      "Disabled ID",     "200",      "T"}
                        };
            ...
            String sql = "";
            sql = "SELECT EMPLOYEE_ID,case when AVAAILED_VEHICLE_FACILITY= 'Y' then 'Yes' ELSE 'No' end as AVAAILED_VEHICLE_FACILITY,"
                    ...
                    + " case when NATIONALITY= 'Y' then 'Yes' WHEN NATIONALITY='N' THEN 'No' ELSE '' end as NATIONALITY,WORKING_MONTH FROM Employee "
        ...
        private string load_report(string table_name, string sql, String[,] matgrid, string[,] matfilter, String sortd, string sortby, int _page, int page_size)
        {
            ...
            string thisPage = "ListOtherInfo.aspx?sortd=" + sortd + "&sortby={sortby}&Id=" + GetEmpId() + "";
            ...
            {
                string sortLink = "<a href=\"#\" class=\"GridHeader\" >";
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                html.Append("<td class=\"text-center\"><a class=\"tool btn btn-primary btn-xs\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Update\" href=\"/Company/EmployeeWeb/ManageOtherInfo.aspx?Id=" + dr["EMPLOYEE_ID"] + "\"><i class=\"fa fa-upload\" id=\"img_Search\"></i></a></td>");
            }
