<%@ Page Title="" Language="C#" MasterPageFile="~/ProjectMaster.Master" AutoEventWireup="true" CodeBehind="ListPastExperience.aspx.cs" Inherits="SwiftHrManagement.web.Company.EmployeeWeb.ListPastExperience" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainPlaceHolder" runat="server">
    <div class="panel">
        <header class="panel-heading">
             <i class="fa fa-caret-right"></i>  List Experience <asp:Label ID="LblEmpName" runat="server"></asp:Label>
        </header>
