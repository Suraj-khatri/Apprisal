...
{
    public partial class ListPastExperience : BasePage
    {
        clsDAO _clsdao = null;
        RoleMenuDAOInv _roleMenuDao = null; 
        public ListPastExperience()
        {
            _clsdao = new clsDAO();
        ...
        private void init()
        {
            ...
            String[,] matfilter = new String[,]{  
                        {"comp_name",    "Company Name",         "LT"}                 
                    };

            //column type : T = text , M = Money, D = date , I = image
            String[,] matgrid = new String[,]{
                       
                        {"comp_name",       "Company Name",        "200",      "T"},
                        {"location",    "Location",     "200",      "T"},
                        {"last_designation",    "Last designation",     "200",      "T"},                      
                        };



            string sortby = "Id";
            string table_name = "Employee_PastExp";
            ...
            sql = " select Id,EMPLOYEE_ID, comp_name, location, last_designation, service_from, service_to, last_salary, remarks from Employee_PastExp where EMPLOYEE_ID=" + GetEmpId() + "";
        ...
        private string load_report(string table_name, string sql, String[,] matgrid, string[,] matfilter, String sortd, string sortby, int _page, int page_size)
        {
            ...
            // string thisPage = "ListPastExperience.aspx?sortd=" + sortd + "&sortby={sortby}";

            string thisPage = "ListPastExperience.aspx?sortd=" + sortd + "&sortby={sortby}&Id=" + GetEmpId() + "";
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                html.Append("<td><a class=\"tool btn btn-primary btn-xs\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"View\" href=\"/Company/EmployeeWeb/ManagePastExperience.aspx?Id=" + dr["Id"] + "&EmpId=" + GetEmpId() + "\"><i class=\"fa fa-eye\"></i></a></td>");
            ...
            string navigation_bar = get_paging_block(total_record, _page, page_size, true, "/Company/EmployeeWeb/ManagePastExperience.aspx?EmpId=" + GetEmpId() + "");
            // string navigation_bar = get_paging_block(total_record, _page, page_size, true, "/Company/EmployeeWeb/ManagePastExperience.aspx");
