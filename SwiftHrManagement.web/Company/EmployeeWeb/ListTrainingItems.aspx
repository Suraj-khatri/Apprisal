<%@ Page Title="" Language="C#" MasterPageFile="~/ProjectMaster.Master" AutoEventWireup="true" CodeBehind="ListTrainingItems.aspx.cs" Inherits="SwiftHrManagement.web.Company.EmployeeWeb.ListTrainingItems" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainPlaceHolder" runat="server">
 <div class="panel">
        <header class="panel-heading">
            <i class="fa fa-caret-right"></i>   List Training  
        </header>
