<%@ Page Title="" Language="C#" MasterPageFile="~/ProjectMaster.Master" AutoEventWireup="true" CodeBehind="ListPersionalPromotion.aspx.cs" Inherits="SwiftHrManagement.web.Company.EmployeeWeb.Promotion.ListPersionalPromotion" %>
...
<table width="100%">
                        <tr>
                            <td align="left" class="wellcome" valign="bottom">
                                <img src="../../../Images/big_bullit.gif" />&nbsp;&nbsp;Employee Service Details
                            </td>
                        </tr>
                        <tr>
