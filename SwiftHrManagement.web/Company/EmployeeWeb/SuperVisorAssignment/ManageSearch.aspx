<%@ Page Language="C#" MasterPageFile="~/ProjectMaster.Master" AutoEventWireup="true" CodeBehind="ManageSearch.aspx.cs" Inherits="SwiftHrManagement.web.Company.EmployeeWeb.SuperVisorAssignment.ManageSearch" Title="Untitled Page" %>
    ...
    <table width="100%">
        <tr>
            <td align="left" class="wellcome" valign="bottom">
              ...
              <img src="../../../Images/big_bullit.gif" />&nbsp;&nbsp;SuperVisor Assignment Details 
            </td>
        </tr>
        <tr>
