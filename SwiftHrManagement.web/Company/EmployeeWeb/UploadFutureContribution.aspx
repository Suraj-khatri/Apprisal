<%@ Page Title="" Language="C#" MasterPageFile="~/SwiftHRManager.Master" AutoEventWireup="true" CodeBehind="UploadFutureContribution.aspx.cs" Inherits="SwiftHrManagement.web.Company.EmployeeWeb.UploadFutureContribution" %>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td class="wellcome" valign="bottom">
                                        ...
                                        &nbsp;Future Contribution Upload CSV File
                                    </td>
                                </tr>
                                <tr>
...
<!--################ START FORM STYLE-->
 <table class="container" border="0" cellpadding="0" cellspacing="0" width="40%">
  <tbody><tr>
    ...
    <td width="91%" class="container_tmid"><div>Upload CSV file for Future Contribution</div></td>
 ...
 <table border="0" cellspacing="5" cellpadding="5" class="container" width="40%">  
        ...
        <tr>
            <td colspan="2" nowrap="nowrap">
                ...
                <a target='_blank' href="../../doc/payroll_upload/futuretaxcontribution/excel_upload.csv" alt="Sample File">Get Sample Upload File</a>
                <br />
