...
{
    public partial class UploadFuturePayable : BasePage
    {
        FileUploaderDao _fileuploader = null;
        RoleMenuDAOInv _roleMenuDao = null;
        clsDAO _clsdao = null;
        public UploadFuturePayable()
        {
            _clsdao = new clsDAO();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                //}
                _clsdao.CreateDynamicDDl(DdlBenefitHead, "Exec ProcStaticDataView 'm',@mul_typeid='41'", "ROWID", "DETAIL_TITLE", "SelectValue", "Select...");
            }            
        }
        ...
        protected void BtnUpload_Click(object sender, EventArgs e)
        {
            ...
            string msg = _clsdao.GetSingleresult("exec ProcUploadAdhocPaymentFile @flag='f',@head=" + filterstring(DdlBenefitHead.Text) + ","
