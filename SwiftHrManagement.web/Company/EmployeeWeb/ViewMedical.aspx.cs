...
{
    public partial class ViewMedical : BasePage
    {
        ...
        private void init()
        {
            ...
            String[,] matgrid = new String[,]{
                        {"PROBLEM",            "Problem",             "200",      "T"},
                        {"DIAGNOSIS",            "Diagnosis",             "200",      "T"},
                        {"DOCTOR",       "Doctor",        "200",      "T"},
                        {"HOSPITAL",    "Hospital",     "200",      "T"},
                        {"CHACHED_DATE",    "Checked Date",     "200",      "D"},
                        {"DESEASE",    "Disease",     "200",      "T"}
                        };



            string sortby = "MEDICAL_ID";
            string table_name = "Employee_Medical";

            String sql = "";

            sql = "SELECT MEDICAL_ID,EMPLOYEE_ID,PROBLEM,DIAGNOSIS,DOCTOR,HOSPITAL,convert(varchar,CHACHED_DATE,107) as CHACHED_DATE,"
                    +" DESEASE FROM Employee_Medical WHERE EMPLOYEE_ID="+GetEmpId()+"";
        ...
        private string load_report(string table_name, string sql, String[,] matgrid, string[,] matfilter, String sortd, string sortby, int _page, int page_size)
        {
            ...
            string thisPage = "ViewMedical.aspx?sortd=" + sortd + "&sortby={sortby}&Id=" + GetEmpId() + "";
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                html.Append("<td class=\"text-center\"><a class=\"tool btn btn-primary btn-xs\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"View\" href=\"/Company/EmployeeWeb/EmpMedicalHistory.aspx?Id=" + dr["MEDICAL_ID"] + "&EmpId=" + GetEmpId() + "\"><i class=\"fa fa-eye\"></i></a></td>");
                html.Append("</tr>");
            }
            ...
            string navigation_bar = get_paging_block(total_record, _page, page_size, true, "/Company/EmployeeWeb/EmpMedicalHistory.aspx?EmpId=" + GetEmpId() + "");
