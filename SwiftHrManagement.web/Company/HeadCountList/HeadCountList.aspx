<%@ Page Title="" Language="C#" MasterPageFile="~/SwiftHRManager.Master" AutoEventWireup="true" CodeBehind="HeadCountList.aspx.cs" Inherits="SwiftHrManagement.web.Company.HeadCountList.HeadCountList" %>
                ...
                <div class="col-md-12 col-sm-12">
                    <section class="panel">
                        <div class="panel-body">
                            ...
                            <asp:Button ID="hdnBtn" runat="server" OnClick="btnHidden_Click" Style="display: none" />
                        </div>
                    </section>
                </div>
            </div>
