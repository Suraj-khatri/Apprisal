<%@ Page Language="C#" MasterPageFile="~/SwiftHRManager.Master" AutoEventWireup="true" CodeBehind="ListVerify.aspx.cs" Inherits="SwiftHrManagement.web.DailyActivityReport.ListVerify" Title="Untitled Page" %>
...
<table width="100%">
                        <tr>
                            <td align="left" class="wellcome" valign="bottom">
                                <img src="../Images/big_bullit.gif" />&nbsp;&nbsp;Verify Daily Activity 
                            </td>
                        </tr>
                        <tr>
