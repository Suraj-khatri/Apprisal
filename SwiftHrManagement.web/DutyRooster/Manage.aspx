<%@ Page Title="" Language="C#" MasterPageFile="~/SwiftHRManager.Master" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="SwiftHrManagement.web.DutyRooster.Manage" %>
...
<!--################ END FORM STYLE-->
    ...
    <table border="0" cellspacing="5" cellpadding="5" class="container">
        ...
        <tr>
            <td nowrap="nowrap"><div align="right" class="txtlbl">Off Day:</div></td>
