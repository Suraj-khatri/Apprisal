...
namespace SwiftHrManagement.web.EmployeeMovement.Clearance
{
    public partial class List : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                //if (_RoleMenuDAOInv.hasAccess(ReadSession().AdminId, 50) == false)
                //{
        ...
        private void init()
        {
            ...
            sql = @"SELECT ID,DBO.GetEmployeeFullNameOfId(STAFF_ID) EMPLOYEE_NAME,DBO.GetBranchName(BRANCH_ID) BRANCH_NAME,
                    ...
                    CONVERT(VARCHAR,EFFECTIVE_DATE,107) EFFECTIVE_DATE,DISCRIPTION [DESC],IS_CLEARANCE 
        ...
        private string load_report(string table_name, string sql, String[,] matgrid, string[,] matfilter, String sortd, string sortby, int _page, int page_size)
        {
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                html.Append("<td class=\"text-center\"><a class=\"tool btn btn-primary btn-xs\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Clearance Sheet\" href=\"Manage.aspx?ID=" + dr["ID"] + "\"><i class=\"fa fa-eye\"></i></a></td>");
                //html.Append("<td><a href=\"Manage.aspx?ID=" + dr["ID"] + "\">Clearance Sheet</a></td>");
                if (dr["IS_CLEARANCE"].ToString() == "Y")
                {
                    html.Append("<td class=\"text-center\"><a class=\"tool btn btn-primary btn-xs\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Clearance Sheet\" href=\"/EmployeeMovement/Clearance/PrintCS.aspx?ID=" + dr["ID"] + "\"><i class=\"fa fa-print\"></i></a></td>");
                    //html.Append("<td><a href=\"/EmployeeMovement/Clearance/PrintCS.aspx?ID=" + dr["ID"] + "\">Print</a></td>");
                }
                else
                {
                    html.Append("<td>N/A</td>");
                }
                html.Append("<td class=\"text-center\"><a class=\"tool btn btn-primary btn-xs\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Exit Interview\" href=\"/EmployeeMovement/ExitInterview/Manage.aspx?ID=" + dr["ID"] + "\"><i class=\"fa fa-pencil\"></i></a></td>");
                //html.Append("<td><a href=\"/EmployeeMovement/ExitInterview/Manage.aspx?ID=" + dr["ID"] + "\">Exit Interview</a></td>");
                html.Append("</tr>");
            }
