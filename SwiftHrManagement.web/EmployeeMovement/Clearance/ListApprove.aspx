<%@ Page Title="" Language="C#" MasterPageFile="~/SwiftHRManager.Master" AutoEventWireup="true" CodeBehind="ListApprove.aspx.cs" Inherits="SwiftHrManagement.web.EmployeeMovement.Clearance.ListApprove" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainPlaceHolder" runat="server">
    <div class="panel">
        <header class="panel-heading">
           ...
           Pending Clearing Sheet of Discontinuous
        </header>
