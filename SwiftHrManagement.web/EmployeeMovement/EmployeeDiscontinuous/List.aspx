<%@ Page Language="C#" MasterPageFile="~/SwiftHRManager.Master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="SwiftHrManagement.web.EmployeeDiscontinuous.List" Title="Swift HRM" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainPlaceHolder" runat="server">
    ...
    <div class="panel">
        <header class="panel-heading">
            ...
            Employement Discontinuation Details
        </header>
