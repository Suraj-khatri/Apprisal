    ...
    public partial class List : BasePage
    {
        ...
        private void init()
        {
            ...
            sql = @"SELECT A.DEPT_ID,A.BRANCH_ID,A.STAFF_ID,A.ID,DBO.GetEmployeeFullNameOfId(STAFF_ID) EMPLOYEE_NAME,DBO.GetBranchName(A.BRANCH_ID) BRANCH_NAME,
		                ...
		                WHERE IS_EXIT_INTERVIEW IS NULL AND STAFF_ID="+ReadSession().Emp_Id+"";
        ...
        private string load_report(string table_name, string sql, String[,] matgrid, string[,] matfilter, String sortd, string sortby, int _page, int page_size)
        {
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                html.Append("<td class=\"text-center\"><a class=\"tool btn btn-primary btn-xs\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"View\" href=\"/EmployeeMovement/ExitInterview/Manage.aspx?ID=" + dr["ID"] + "\"><i class=\"fa fa-eye\"></i></a></td>");
