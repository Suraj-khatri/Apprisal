...
{
    public partial class ListAll : BasePage
    {
        ...
        private void init()
        {
            ...
            sql = @"SELECT A.DEPT_ID,A.BRANCH_ID,A.STAFF_ID,A.ID,DBO.GetEmployeeFullNameOfId(STAFF_ID) EMPLOYEE_NAME,DBO.GetBranchName(A.BRANCH_ID) BRANCH_NAME,
		                ...
		                WHERE IS_EXIT_INTERVIEW IS NULL ";
        ...
        private string load_report(string table_name, string sql, String[,] matgrid, string[,] matfilter, String sortd, string sortby, int _page, int page_size)
        {
            ...
            string thisPage = "ListAll.aspx?sortd=" + sortd + "&sortby={sortby}";
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                //html.Append("<td><a href=\"/EmployeeMovement/ExitInterview/Manage.aspx?flag=a&ID=" + dr["ID"] + "\">Exit Interview</a></td>");
                html.Append("<td class=\"text-center\"><a class=\"tool btn btn-primary btn-xs\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"View\" href=\"/EmployeeMovement/ExitInterview/Manage.aspx?flag=a&ID=" + dr["ID"] + "\"><i class=\"fa fa-eye\"></i></a></td>");
                html.Append("</tr>");
            }
