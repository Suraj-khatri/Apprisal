<%@ Page Language="C#" MasterPageFile="~/SwiftHRManager.Master" AutoEventWireup="true" CodeBehind="InternalList.aspx.cs" Inherits="SwiftHrManagement.web.InternalTransferPlan.InternalList" Title="Swift HRM" %>
...
<table width="100%">
                        <tr>
                            <td align="left" class="wellcome" valign="bottom">
                                <img src="../../Images/big_bullit.gif" />&nbsp;&nbsp;Employee Internal Transfer Details 
                            </td>
                        </tr>
                        <tr>
