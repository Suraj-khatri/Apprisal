...
{
    public partial class InternalList : BasePage
    {
        ...
        private void init()
        {
            ...
            String[,] matgrid = new String[,]{
                        ...
                        {"FROM_DEPARTMENT",       "From Department",        "200",      "LT"},
                        {"WHICH_DEPARTMENT",    "Transfer Department",     "200",      "LT"}, 
                        {"WHICH_POSITION",    "Transfer Position",     "200",      "LT"}, 
            ...
            sql = "SELECT	ETP.ID,E.FIRST_NAME,E.FIRST_NAME + ' ' + E.MIDDLE_NAME + ' ' + E.LAST_NAME AS STAFF_ID,D1.DEPARTMENT_NAME AS FROM_DEPARTMENT,"
                        + " D.DEPARTMENT_NAME AS WHICH_DEPARTMENT,S.DETAIL_TITLE AS WHICH_POSITION,convert(varchar,ETP.EFFECTIVE_DATE,107) as EFFECTIVE_DATE,"
                        + " convert(varchar,ETP.ACTUAL_REPORT_DATE,107) as ACTUAL_REPORT_DATE,ETP.TRANSFER_DESCRIPTION,ETP.CREATED_BY, convert(varchar,ETP.CREATED_DATE,107) as CREATED_DATE, ETP.MODIFIED_BY,convert(varchar,ETP.MODIFIED_DATE,107) as MODIFIED_DATE"
                + " FROM	dbo.ExternalTransferPlan AS ETP "
                        ...
                        + " INNER JOIN dbo.StaticDataDetail AS S ON S.ROWID = ETP.WHICH_POSITION "
                        + " where TRANSFER_TYPE='i' and FROM_BRANCH=" + filterstring(ReadSession().Branch_Id.ToString()) + " AND WHICH_BRANCH=" + filterstring(ReadSession().Branch_Id.ToString()) + "";
        ...
        private string load_report(string table_name, string sql, String[,] matgrid, string[,] matfilter, String sortd, string sortby, int _page, int page_size)
        {
            ...
            string thisPage = "InternalList.aspx?sortd=" + sortd + "&sortby={sortby}";
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                html.Append("<td><a href=\"/EmployeeMovement/InternalTransferPlan/Manage.aspx?ID=" + dr["ID"] + "\">View</a></td>");
            ...
            string navigation_bar = get_paging_block(total_record, _page, page_size, true, "/EmployeeMovement/InternalTransferPlan/Manage.aspx");
