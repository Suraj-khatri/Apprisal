<%@ Page Title="" Language="C#" MasterPageFile="~/SwiftHRManager.Master" AutoEventWireup="true" CodeBehind="TemporaryTransfer.aspx.cs" Inherits="SwiftHrManagement.web.EmployeeMovement.TemporaryTransferPlan.TemporaryTransfer" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainPlaceHolder" runat="server">
    <div class="panel">
        <header class="panel-heading">
          ...
          Employee Temporary Transfer Details 
        </header>
