<%@ Page Title="" Language="C#" MasterPageFile="~/SwiftHRManager.Master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="SwiftHrManagement.web.EmployeeMovement.TransferRequest.List" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    function nav(page) {
        var hdd = document.getElementById("hdd_cu       rr_page");
        if (hdd != null)
            hdd.value = page;
