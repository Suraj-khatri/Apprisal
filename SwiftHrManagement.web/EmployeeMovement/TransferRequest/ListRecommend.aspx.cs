...
{
    public partial class ListRecommend : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                //if (_roleMenuDao.hasAccess(ReadSession().AdminId, 15) == false)
                //{
        ...
        private void init()
        {
            ...
            String[,] matfilter = new String[,]{
                        ...
                        {"dbo.GetEmployeeFullNameOfId(ETP.recommend_by)",    "Recommend By",         "LT"}, 
            ...
            String[,] matgrid = new String[,]{
                        ...
                        {"recommend_by",           "Recommend By",          "200",     "LT"},
            ...
            sql = @"SELECT ETP.ID
                            ...
                            dbo.GetEmployeeFullNameOfId(ETP.recommend_by) recommend_by
                            FROM ExternalTransferPlan ETP
                            inner join Employee e on ETP.STAFF_ID = e.EMPLOYEE_ID
                            where TRANSFER_TYPE IN ('e','i','d') and recommend_by=" + ReadSession().Emp_Id+" AND STATUS='Requested'";
        ...
        private string load_report(string table_name, string sql, String[,] matgrid, string[,] matfilter, String sortd, string sortby, int _page, int page_size)
        {
            ...
            string thisPage = "ListRecommend.aspx?sortd=" + sortd + "&sortby={sortby}";
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                html.Append("<td><a href=\"/EmployeeMovement/TransferRequest/ManageRecommend.aspx?ID=" + dr["ID"] + "\">View</a></td>");
                 //html.Append("<td class=\"text-center\"><a class=\"tool btn btn-primary btn-xs\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"View\" href=\"/SysUserInv/Manage.aspx?Admin_Id=" + dr["AdminID"] +"\"><i class=\"fa fa-eye\"></i></a></td>");
                html.Append("</tr>");
            }
            ...
            string navigation_bar = get_paging_block(total_record, _page, page_size, true, "/EmployeeMovement/TransferRequest/ManageRecommend.aspx");
