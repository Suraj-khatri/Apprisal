<%@ Page Title="" Language="C#" MasterPageFile="~/SwiftHRManager.Master" AutoEventWireup="true" CodeBehind="ApproveTO.aspx.cs" Inherits="SwiftHrManagement.web.EmployeeMovement.TravelOrder.ApproveTO" %>
...
<table width="100%">
                        <tr>
                            <td align="left" class="wellcome" valign="bottom">
                                <img src="../../Images/big_bullit.gif" />&nbsp;&nbsp;Travel Order Approve Details 
                            </td>
                        </tr>
                        <tr>
