<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/SwiftHRManager.Master" CodeBehind="ListHrApprove.aspx.cs" Inherits="SwiftHrManagement.web.EmployeeMovement.TravelOrder.ListHrApprove" %>
...
<table width="100%">
                        <tr>
                            <td align="left" class="wellcome" valign="bottom">
                                <img src="../../Images/big_bullit.gif" />&nbsp;&nbsp;Travel Order Verify Details 
                            </td>
                        </tr>
                        <tr>
