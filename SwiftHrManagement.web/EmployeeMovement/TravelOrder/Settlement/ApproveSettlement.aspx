<%@ Page Title="" Language="C#" MasterPageFile="~/SwiftHRManager.Master" AutoEventWireup="true" CodeBehind="ApproveSettlement.aspx.cs" Inherits="SwiftHrManagement.web.EmployeeMovement.TravelOrder.Settlement.ApproveSettlement" %>
...
<table width="100%">
    <tr>
        <td align="left" class="wellcome" valign="bottom">
            <img src="../../Images/big_bullit.gif" />&nbsp;&nbsp;TravelOrder Settlement Approve Details 
        </td>
    </tr>
    <tr>
