<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" MasterPageFile="~/SwiftHRManager.Master" Inherits="SwiftHrManagement.web.EmployeeMovement.TravelOrder.Settlement.List" %>
...
<table width="100%">
                        <tr>
                            <td align="left" class="wellcome" valign="bottom">
                                <img src="../../../Images/big_bullit.gif" />&nbsp;&nbsp;Travel Order Settlement 
                            </td>
                        </tr>
                        <tr>
