<%@ Page Title="" Language="C#" MasterPageFile="~/SwiftHRManager.Master" AutoEventWireup="true" CodeBehind="RecommendSettlement.aspx.cs" Inherits="SwiftHrManagement.web.EmployeeMovement.TravelOrder.Settlement.RecommendSettlement" %>
...
<table width="100%">
    <tr>
        <td align="left" class="wellcome" valign="bottom">
            <img src="../../../Images/big_bullit.gif" />&nbsp;&nbsp;TravelOrder Settlement Recommend Details 
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td align="center">
             <div>
                <div id="rptRecommend" runat="server"></div>
