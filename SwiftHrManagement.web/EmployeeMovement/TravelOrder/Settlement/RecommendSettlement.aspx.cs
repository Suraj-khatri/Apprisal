...
{
    public partial class RecommendSettlement : BasePage
    {
        RoleMenuDAOInv _RoleMenuDAOInv = null;
        public RecommendSettlement()
        {
        ...
        private void init()
        {
            ...
            String[,] matgrid = new String[,]{
                        ...
                        {"requestRemarks",      "Requested Remarks",  "200",      "LT"},
                        };
            ...
            sql = "SELECT travelOrdSetId,travelOrderId,dbo.GetEmployeeFullNameOfId(reqBy)reqBy,ReqDate,convert(varchar,settlementfromDate,107)settlementfromDate,convert(varchar,settlementtoDate,107)settlementtoDate"
                 + " ,requestRemarks FROM travelOrderSettlement WHERE reqDate IS NOT NULL AND recommendedDate IS NULL and recommendedBy=" + filterstring(ReadSession().Emp_Id.ToString());
            ...
            rptRecommend.InnerHtml = "<center>" + load_report(table_name, sql, matgrid, matfilter, sortd, sortby, _page, page_size) + "</center>";
        ...
        private string load_report(string table_name, string sql, String[,] matgrid, string[,] matfilter, String sortd, string sortby, int _page, int page_size)
        {
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                html.Append("<td><a href=\"/EmployeeMovement/TravelOrder/Settlement/ManageRecoSettlement.aspx?flag=r&TravelOID=" + dr["travelOrderId"] + "&TravelOSID=" + dr["travelOrdSetId"] + "\">Approve</a></td>");
