<%@ Page Title="" Language="C#" MasterPageFile="~/SwiftHRManager.Master" AutoEventWireup="true" CodeBehind="VerifySettlement.aspx.cs" Inherits="SwiftHrManagement.web.EmployeeMovement.TravelOrder.Settlement.VerifySettlement" %>
...
<table width="100%">
    <tr>
        <td align="left" class="wellcome" valign="bottom">
            <img src="../../Images/big_bullit.gif" />&nbsp;&nbsp;TravelOrder Settlement Verify Details 
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td align="center">
             <div>
                <div id="rptVerify" runat="server"></div>
