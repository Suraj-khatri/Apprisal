...
{
    public partial class VerifySettlement : BasePage
    {
        ...
        private void init()
        {
            ...
            String[,] matgrid = new String[,]{
                        ...
                        //{"settlementtoDate",    "Settlement To",  "200",      "D"},
                        //{"requestRemarks",      "Request Remarks",  "200",      "LT"},
                        {"recommendedBy",       "Recommended By",   "200",      "LT"},
                        {"recommendedDate",     "Recommended Date",   "200",      "LT"},
            ...
            sql = "SELECT travelOrdSetId,travelOrderId,dbo.GetEmployeeFullNameOfId(reqBy)reqBy,ReqDate,settlementfromDate,"
            +" settlementtoDate,requestRemarks,dbo.GetEmployeeFullNameOfId(recommendedBy) recommendedBy,recommendedDate,"
            + " recommendedRemarks FROM travelOrderSettlement WHERE recommendedDate IS NOT NULL AND finalApproveByDate IS NULL";
            ...
            rptVerify.InnerHtml = "<center>" + load_report(table_name, sql, matgrid, matfilter, sortd, sortby, _page, page_size) + "</center>";
        ...
        private string load_report(string table_name, string sql, String[,] matgrid, string[,] matfilter, String sortd, string sortby, int _page, int page_size)
        {
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                html.Append("<td><a href=\"/EmployeeMovement/TravelOrder/Settlement/ManageRecoSettlement.aspx?flag=v&TravelOID=" + dr["travelOrderId"] + "&TravelOSID=" + dr["travelOrdSetId"] + "\">Approve</a></td>");
