...
namespace SwiftHrManagement.web.FlightDetails.Approve
{
    public partial class List : BasePage
    {
        ...
        {
            if (_roleMenuDao.hasAccess(ReadSession().AdminId, 272) == false)
            {
        ...
        private void init(long EmpId)
        {
            ...
            String[,] matfilter = new String[,]{
                        {"FLIGHT_APPROVE_STATUS",   "Status",                "LT"},
            ...
            String[,] matgrid = new String[,]{
                        ...
                        {"FlightTime",              "Flight Time/Schedule",     "200",      "T"},                        
                        {"FLIGHT_APPROVE_STATUS",   "Approval Status",          "200",      "T"}
                        };

            string sortby = "id";
            string table_name = "FlightDetails";
            ...
            sql = @"SELECT
						...
						,ToPlace
						,FlightTime
			            ,ApproveStatus AS FLIGHT_APPROVE_STATUS
		            FROM FlightDetails fd 
                    LEFT JOIN Employee e ON e.EMPLOYEE_ID=fd.emp_id
                    INNER JOIN Flight_Authorization fa ON fa.flightId = fd.id
		            WHERE fa.Authorised_By = " + EmpId + "and ApproveStatus = 'Pending'";
        ...
        private string load_report(string table_name, string sql, String[,] matgrid, string[,] matfilter, String sortd, string sortby, int _page, int page_size)
        {
            ...
            for (int i = 0; i <= arr_cnt; i++)
            {
                ...
                html.Append("<th Class=\"HeaderStyle\" align=\"left\">" + sortLink + matgrid.GetValue(i, 1) + "</a></th>");
            }
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                html.Append("<td class=\"text-center\"><a class=\"tool btn btn-primary btn-xs\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"View\" href=\"/FlightDetails/Approve/Manage.aspx?flagID=1&id=" + dr["id"] + "\"><i class=\"fa fa-eye\"></i></a></td>");
                html.Append("</tr>");
            }
