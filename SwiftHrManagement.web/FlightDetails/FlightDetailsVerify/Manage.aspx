<%@ Page Title="" Language="C#" MasterPageFile="~/SwiftHRManager.Master" AutoEventWireup="true"
    CodeBehind="Manage.aspx.cs" Inherits="SwiftHrManagement.web.FlightDetails.FlightDetailsVerify.Manage" %>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <fieldset class="form-group">
                                    <legend>Verification Message</legend>
                                    <asp:TextBox runat="server" ID="txtVerificationMsg" CssClass="form-control" TextMode="MultiLine"/>
                                </fieldset>
                            </div>
                        </div>
                        <div class="form-group">
                            <asp:Button ID="BtnSave" runat="server" CssClass="btn btn-primary" OnClick="BtnSave_Click" Text="Verify" />
