<%@ Page Title="" Language="C#" MasterPageFile="~/SwiftHRManager.Master" AutoEventWireup="true"
    CodeBehind="Manage.aspx.cs" Inherits="SwiftHrManagement.web.FlightDetails.PaymentDetails.Manage" %>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <fieldset class="form-group">
                                    ...
                                    <asp:TextBox runat="server" ID="txtPaymentInfo" CssClass="form-control" TextMode="MultiLine"/>
                                </fieldset>
                            </div>
                        </div>
