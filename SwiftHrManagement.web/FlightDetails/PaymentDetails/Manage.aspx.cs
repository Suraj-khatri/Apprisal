...
namespace SwiftHrManagement.web.FlightDetails.PaymentDetails
{
    public partial class Manage : BasePage
    {
        ...
        public void PopulateFlightDetails()
        {
            ...
            txtPaymentInfo.Text = dr["paidMsg"].ToString();

            if (dr["paidStatus"].ToString() == "Pending")
            {
                txtPaymentInfo.ReadOnly = false;
            }

            else if (dr["paidStatus"].ToString() == "Paid")
            {
                txtPaymentInfo.ReadOnly = true;
        ...
        {
            string sql;
            sql = "EXEC procManageFlightDetails @flag='py', @user=" + filterstring(ReadSession().Emp_Id.ToString()) + ", @id=" + filterstring(GetID().ToString()) + ", @paidMsg=" + filterstring(txtPaymentInfo.Text);
