<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/SwiftHRManager.Master" CodeBehind="Manage.aspx.cs" Inherits="SwiftHrManagement.web.FlightDetails.Request.Manage" %>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td nowrap="nowrap" colspan="3">
                                                                                            ...
                                                                                            <asp:TextBox ID="txtEmpName" runat="server"
                                                                                                Width="478px" AutoPostBack="true"  CssClass="inputTextBoxLP" 
                                                                                                ontextchanged="txtEmpName_TextChanged" Height="18px" />
                                                                                ...
                                                                                <table>
                                                                                    ...
                                                                                    <td>
                                                                                     <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                                                                                            ControlToValidate="txtPurpose" ErrorMessage="Required!" ValidationGroup="flight"
                                                                                            SetFocusOnError="True"/>
                                                                                    </td>
                                                                                        <td>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <asp:Button ID="BtnSave" runat="server" CssClass="button" 
                                                                            onclick="BtnSave_Click" Text="Save" Width="50" ValidationGroup="flight" />
