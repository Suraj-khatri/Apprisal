<%@ Page Title="" Language="C#" MasterPageFile="~/SwiftHRManager.Master" AutoEventWireup="true" CodeBehind="ManageIndividual.aspx.cs" Inherits="SwiftHrManagement.web.FlightDetails.RequestIndividual.ManageIndividual" %>
...
<script type="text/javascript">
    ...
    <script type="text/javascript" language="javascript">
        function validation() {
            if (!window.Page_ClientValidate('flight'))
                return false;
        }
                ...
                <section class="panel">
                    <header class="panel-heading">
                        <i class="fa fa-caret-right" aria-hidden="true"></i>  
                            Flight Details Individual Request
                    </header>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group autocomplete-form">
                                    ...
                                    <asp:TextBox ID="txtEmpName" runat="server" AutoPostBack="true"  CssClass="form-control"  />
