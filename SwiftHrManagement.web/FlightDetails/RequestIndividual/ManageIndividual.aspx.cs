...
{
    public partial class ManageIndividual : BasePage
    {
         clsDAO CLsDAo = null;
        RoleMenuDAOInv _roleMenuDao = null;
        FlightDetailsDao _flightDao = null;

        public ManageIndividual()
        {
            CLsDAo = new clsDAO();
        ...
        private void ManageFlight(char flag)
        {
            ...
            Response.Redirect("ListIndividual.aspx");
        }
        ...
        protected void employeedetail()
        {
            ...
            this.lblBranch.Text = dr["branchName"].ToString();
            this.lblDepartment.Text = dr["deptName"].ToString();
            this.lblPosition.Text = dr["positionName"].ToString();

        }

        protected void BtnDelete_Click(object sender, EventArgs e)
        {
            var sql = "Exec procManageFlightDetails @flag='d',@id=" + filterstring(GetID().ToString()) + ",@flightId=" +
