...
namespace SwiftHrManagement.web.FlightDetails.RequestIndv
{
    public partial class List : BasePage
    {
        ...
        private void init()
        {
            ...
            String[,] matgrid = new String[,]{                         
                        ...
                        {"ApproveStatus",        "Approval Status",        "200",      "T"}
        ...
        private string load_report(string table_name, string sql, String[,] matgrid, string[,] matfilter, String sortd, string sortby, int _page, int page_size)
        {
            ...
            string navigation_bar = get_paging_block(total_record, _page, page_size, true, "/FlightDetails/RequestIndv/Manage.aspx");
