<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InvenotrySummaryExpensesBranchWise.aspx.cs" Inherits="SwiftHrManagement.web.Inventory.InvenotrySummaryExpensesBranchWise" %>
...
<table border="0" cellpadding="2" cellspacing="2" align="center">
            <tr>
                <td colspan="2" style="text-align: center"><div id="divCompany" class="ReportHeader" runat="server"></div>
                    <div id="Div1" class="ReportSubHeader">Inventory Summary Expenses Report Branch Wise<br />
