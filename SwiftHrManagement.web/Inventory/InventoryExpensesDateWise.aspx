<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InventoryExpensesDateWise.aspx.cs" Inherits="SwiftHrManagement.web.Inventory.InventoryExpensesDateWise" %>
...
<form id="form1" runat="server">
        <table border="0" cellpadding="2" cellspacing="2" align="center" >
            <tr>
                ...
                <div id="Div1" class="ReportSubHeader" runat="server" style="text-align: center">Inventory Expenses Date Wise</div><br />
                
                 <div id="Div2" runat="server" style="text-align: center" class="ReportSubHeader">  
                 Branch Name : <asp:Label ID="branchname" runat="server" CssClass="txtlbl"></asp:Label><br />
                 Report on date <asp:Label ID="from_date" runat="server" Text="Label" CssClass="txtlbl"></asp:Label>&nbsp;
                    To  <asp:Label ID="to_date" runat="server" Text="Label" CssClass="txtlbl"></asp:Label>
                    </div>
            ...
            <tr>
                <td colspan="2" align="left"><div id="rpt" runat="server"></div>
                    &nbsp;</td>
            </tr>
        </table>
</form>
