...
{
    public partial class InventoryExpensesPriceWise : BasePage
    {
        ...
        public InventoryExpensesPriceWise()
        {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DataTable dt = _clsdao.getTable("Exec procStockInHand 'd', " + filterstring(GetBranchID().ToString()) + "," + filterstring(GetProductID().ToString())+",'null','null'");
