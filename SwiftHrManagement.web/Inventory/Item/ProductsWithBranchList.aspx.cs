...
namespace SwiftHrManagement.web.Inventory.Item
{
    public partial class ProductsWithBranchList : BasePage
    {
        ClsDAOInv _clsdao = null;
        RoleMenuDAOInv _RoleMenuDAOInv = null;
        public ProductsWithBranchList()
        {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                if (_RoleMenuDAOInv.hasAccess(ReadSession().AdminId, 109) == false)
                {
...
from IN_BRANCH a inner join IN_PRODUCT b on a.PRODUCT_ID=b.ID inner join Branches c on c.BRANCH_ID=a.BRANCH_ID WHERE 1=1";
