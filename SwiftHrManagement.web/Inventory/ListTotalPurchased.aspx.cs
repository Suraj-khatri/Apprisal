...
{
    public partial class ListTotalPurchased : BasePage
    {
        ...
        {
            return (Request.QueryString["vendorId"] != null ? (Request.QueryString["vendorId"]) : "");
        }
        ...
        private void PrintReport()
        {
            ...
            DataTable dt = _clsdao.getTable("Exec procStockInHand @flag='p', @Branch=" + filterstring(GetBranchID().ToString()) + ","+
            "@product=" + filterstring(GetProductID().ToString()) + ",@from="+filterstring(GetFromDate())+",@to="+filterstring(GetToDate())+","+
            "@vendorId=" + filterstring(GetVendorId()) + ",@groupId=" + filterstring(GetProductGroupID()) + "");

            _CompanyCore = _company.FindCompany();

            this.divCompany.InnerText = _CompanyCore.Name;
            //this.lbldesc.Text = _CompanyCore.Address;o
