<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewTransferOutRpt.aspx.cs" Inherits="SwiftHrManagement.web.Inventory.ViewTransferOutRpt" %>
...
<form id="form1" runat="server">
    <table border="0" cellpadding="2" cellspacing="2" align="center">
            <tr>
                ...
                <div id="Div1" class="ReportSubHeader" runat="server" style="text-align: center">Inventory Transfer Out Report </div><br />
            ...
            <tr>
                <td colspan="2" align="right">Print Date: <asp:Label ID="lblprintDate" runat="server" Text="Label"></asp:Label></td>
            </tr>
            <tr>
