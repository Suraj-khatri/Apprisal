<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="disposalRpt.aspx.cs" Inherits="SwiftHrManagement.web.Inventory.disposalRpt" %>
...
<form id="form1" runat="server">
        <table border="0" cellpadding="2" cellspacing="2" align="center" >
            <tr>
                ...
                <div id="Div1" class="ReportSubHeader" runat="server" style="text-align: center">Inventory Disposal Report</div><br />
