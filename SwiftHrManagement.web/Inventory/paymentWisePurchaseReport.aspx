<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="paymentWisePurchaseReport.aspx.cs" Inherits="SwiftHrManagement.web.Inventory.paymentWisePurchaseReport" %>
...
<body>
    <form id="form1" runat="server">
            ...
            <tr>
                ...
                <div id="Div1" class="ReportSubHeader">Payment Wise Purchase Bill Details<br />
                    Branch Name: <asp:Label ID="lblBranchName" runat="server" CssClass="txtlbl"></asp:Label><br />
                    Vendor Name  <asp:Label ID="lblVendorName" runat="server" CssClass="txtlbl"></asp:Label><br />
                    Report From <asp:Label ID="lblFromDate" runat="server" CssClass="txtlbl"></asp:Label>  To <asp:Label ID="lblTodate" runat="server" CssClass="txtlbl"></asp:Label>
                    </div>   
