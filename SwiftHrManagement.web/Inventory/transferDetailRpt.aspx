<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="transferDetailRpt.aspx.cs" Inherits="SwiftHrManagement.web.Inventory.transferDetailRpt" %>
...
<form id="form1" runat="server">
        <table border="0" cellpadding="2" cellspacing="2" align="center" >
            <tr>
                ...
                <div id="Div1" class="ReportSubHeader" runat="server" style="text-align: center">Inventory Transfer Report</div><br />
