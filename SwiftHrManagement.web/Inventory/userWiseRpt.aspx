<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="userWiseRpt.aspx.cs" Inherits="SwiftHrManagement.web.Inventory.userWiseRpt" %>
...
<form id="form1" runat="server">
        <table align="center">
            <tr>
                ...
                <div id="Div1" class="ReportSubHeader">Inventory Expenses User Wise<br />
                    <br />

                    Branch Name: <asp:Label ID="lblBranchName" runat="server" CssClass="txtlbl"></asp:Label>, 
                    Department: <asp:Label ID="lblDeptName" runat="server" CssClass="txtlbl"></asp:Label>
                   <br />
                    From Date <asp:Label ID="lblFromDate" runat="server" CssClass="txtlbl"></asp:Label> &nbsp;To Date : <asp:Label ID="lblToDate" runat="server" CssClass="txtlbl"></asp:Label>
                    </div>                   
