    ...
    public partial class List : BasePage
    {
        ...
        private void init()
        {
            ...
            sql = "SELECT ID,case when b.BRANCH_NAME IS null then 'All Branch' else b.BRANCH_NAME end as BranchName,"
                    + " TITLE,CONVERT(VARCHAR,DATE,107) AS DATE, NATURE, DESCRIPTION FROM OfficialCalendar oc"
        ...
        private string load_report(string table_name, string sql, String[,] matgrid, string[,] matfilter, String sortd, string sortby, int _page, int page_size)
        {
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                html.Append("<td class=\"text-center\"><a class=\"tool btn btn-primary btn-xs\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"View\" href=\"/LeaveManagementModule/Calender/Manage.aspx?Id=" + dr["ID"] + "&TITLE=" + dr["TITLE"] + "&DATE=" + dr["DATE"] + "\"><i class=\"fa fa-eye\"></i></a></td>");
            ...
            string navigation_bar = get_paging_block(total_record, _page, page_size, true, "/LeaveManagementModule/Calender/Manage.aspx");
