...
{
    public partial class RemarksList : BasePage
    {
        clsDAO _clsdao = null;
        public RemarksList()
        {
        ...
        private void init()
        {
            ...
            sql = "SELECT ID,RMARKS from OfficialCalendar where RMARKS is not null and 1=1 ";
        ...
        private string load_report(string table_name, string sql, String[,] matgrid, string[,] matfilter, String sortd, string sortby, int _page, int page_size)
        {
            ...
            string thisPage = "RemarksList.aspx?sortd=" + sortd + "&sortby={sortby}";
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                html.Append("<td><a href=\"/LeaveManagement/Calender/Manageremarks.aspx?Id=" + dr["ID"] + "\">View</a></td>");
                html.Append("</tr>");
            }
            ...
            string navigation_bar = get_paging_block(total_record, _page, page_size, true, "/LeaveManagement/Calender/Manageremarks.aspx");
