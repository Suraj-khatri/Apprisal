    ...
    public partial class List : BasePage
    {
        ...
        private void init()
        {
            ...
            String[,] matfilter = new String[,]{                        
                        {"LEAVE_TYPE_ID",    "Leave Name",                        "LT"},  
                        {"EMPLOYEE",        "Employee Name",          "LT"},
                        {"ACTIVE",        "Is Active(Yes/No)",          "LT"},
            ...
            string sortby = " EMPLOYEE,LEAVE_TYPE_ID ";
...
//                             inner join Employee E on E.EMPLOYEE_ID=LA.EMPLOYEE_ID 
//                             inner join LeaveTypes LT ON LT.ID=LA.LEAVE_TYPE_ID 
//                             WHERE LA.IS_DISABLED=1 and LA.EMPLOYEE_ID=" + filterstring(GetEmployeeId().ToString()) + " )A	WHERE 1=1 ";
            }
            else
            {
                sql = @"SELECT 
                        ...
                        (
                             ...
                             inner join Employee E on E.EMPLOYEE_ID=LA.EMPLOYEE_ID 
                             inner join LeaveTypes LT ON LT.ID=LA.LEAVE_TYPE_ID 
                             WHERE LA.IS_DISABLED=1  )A WHERE 1=1 ";
            }
        ...
        private string load_report(string table_name, string sql, String[,] matgrid, string[,] matfilter, String sortd, string sortby, int _page, int page_size)
        {
            ...
            long personal = (GetEmployeeId() > 0 ? GetEmployeeId() : 0);
            ...
            string thisPage = "List.aspx?Id="+GetEmployeeId()+"&sortd=" + sortd + "&sortby={sortby}";
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                html.Append("<td class=\"text-center\"><a class=\"tool btn btn-primary btn-xs\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"View\" href=\"/LeaveManagementModule/LeaveAssignment/Manage.aspx?ID=" + dr["ID"] + "&EmpID=" + GetEmployeeId().ToString() + "\"><i class=\"fa fa-eye\"></i></a></td>");
                // html.Append("<td><a href=\"/LeaveManagementModule/Calender/Events/Manage.aspx?Id=" + dr["ID"] + "\">View</a></td>");
                html.Append("</tr>");
            ...
            string navigation_bar = get_paging_block(total_record, _page, page_size, GetEmployeeId() > 0 ? false : true, "/LeaveManagementModule/LeaveAssignment/Manage.aspx?EmpID=" + GetEmployeeId() + "&personal=" + personal.ToString());
