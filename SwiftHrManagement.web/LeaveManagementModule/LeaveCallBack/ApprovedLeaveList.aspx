<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/SwiftHRManager.Master" CodeBehind="ApprovedLeaveList.aspx.cs" Inherits="SwiftHrManagement.web.LeaveManagementModule.LeaveCallBack.ApprovedLeaveList" %>
...
<table width="100%">
                        <tr>
                            <td align="left" class="wellcome" valign="bottom">
                                <img src="../../Images/big_bullit.gif" />&nbsp;Leave Request Details For Approval
                            </td>
                        </tr>
                        <tr>
