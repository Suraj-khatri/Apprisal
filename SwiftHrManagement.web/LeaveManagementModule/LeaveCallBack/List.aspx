<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/SwiftHRManager.Master" CodeBehind="List.aspx.cs" Inherits="SwiftHrManagement.web.LeaveManagementModule.LeaveCallBack.List" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainPlaceHolder" runat="server">
    <div class="panel">
        <header class="panel-heading"> 
             <img src="../../Images/big_bullit.gif" />&nbsp;&nbsp;Approved Leave Call Back Details
         </header>
