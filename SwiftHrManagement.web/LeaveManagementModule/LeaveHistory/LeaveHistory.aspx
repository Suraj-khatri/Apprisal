<%@ Page Language="C#" MasterPageFile="~/SwiftHRManager.Master" AutoEventWireup="true" CodeBehind="LeaveHistory.aspx.cs" Inherits="SwiftHrManagement.web.LeaveManagement.LeaveHistory.LeaveHistory" Title="Untitled Page" %>
...
<table width="100%">
    <tr>
        <td align="left" class="wellcome" valign="bottom">
            <i class="fa fa-caret-right"></i>Leave Request Details
        </td>
    </tr>
    <tr>
