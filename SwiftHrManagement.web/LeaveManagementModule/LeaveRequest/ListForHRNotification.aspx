<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/SwiftHRManager.Master" CodeBehind="ListForHRNotification.aspx.cs" Inherits="SwiftHrManagement.web.LeaveManagementModule.LeaveRequest.ListForHRNotification" %>
...
<table width="100%">
                        <tr>
                            <td align="left" class="wellcome" valign="bottom">
                                <img src="../../Images/big_bullit.gif" />&nbsp;Leave Request Details
                            </td>
                        </tr>
                        <tr>
