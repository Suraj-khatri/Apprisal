<%@ Page Title="" Language="C#" MasterPageFile="~/SwiftHRManager.Master" AutoEventWireup="true"
    CodeBehind="DependentClaimList.aspx.cs" Inherits="SwiftHrManagement.web.MedicalClaim.DependentClaimList" %>
        ...
        <tr>
            <td>
                <table style="width: 100%" class="tabs">
                    <tr>
                        <td height="10">
                            <a href="List.aspx">Medical Claim</a><a href="#" class="selected">Dependent
                                Claim</a>
                        </td>
                    </tr>
                </table>
