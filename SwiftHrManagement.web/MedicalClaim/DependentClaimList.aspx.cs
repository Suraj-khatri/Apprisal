...
{
    public partial class DependentClaimList : BasePage
    {

         RoleMenuDAOInv _roleMenuDao = null;
         public DependentClaimList()
        {
        ...
        private void init()
        {
            ...
            sql = @"SELECT 
                        ...
                        WHERE empId=" + ReadSession().Emp_Id + "and claimFor='Dependent'";
        ...
        private string load_report(string table_name, string sql, String[,] matgrid, string[,] matfilter, String sortd, string sortby, int _page, int page_size)
        {
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                {
                    html.Append("<td><a href=\"/MedicalClaim/DependentClaim.aspx?Id=" + dr["ID"] + "&flag=p\">View</a></td>");
                }
                else
                {
                    html.Append("<td><a href=\"/MedicalClaim/DependentClaim.aspx?Id=" + dr["ID"] + "\">View</a></td>");
                }
            ...
            string navigation_bar = get_paging_block(total_record, _page, page_size, true, "/MedicalClaim/DependentClaim.aspx");
