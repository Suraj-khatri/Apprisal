<%@ Page Title="" Language="C#" MasterPageFile="~/SwiftHRManager.Master" AutoEventWireup="true"
    CodeBehind="List.aspx.cs" Inherits="SwiftHrManagement.web.MedicalClaim.List" %>
    ...
    <%--<table width="100%">
        <tr>
            <td align="left" class="wellcome" valign="bottom">
                <img src="../../Images/big_bullit.gif" />&nbsp;Medical Claim List
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td>
                <table style="width: 100%" class="tabs">
                    <tr>
                        <td height="10">
                            <a href="#" class="selected">Medical Claim</a><a href="DependentClaimList.aspx">Dependent Claim</a>
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <section class="panel">
                        <div class="panel-body">
                           <div> <a href="#" class="selected">Medical Claim</a><a href="DependentClaimList.aspx">Dependent Claim</a></div>
                            <div id="rpt" runat="server">
                    </div>
                    <asp:Button ID="btnHidden" runat="server" OnClick="btnHidden_Click" Style="display: none" />
                        </div>
