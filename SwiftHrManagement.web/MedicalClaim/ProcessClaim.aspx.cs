...
{
    public partial class ProcessClaim : BasePage
    {
       ...
       public ProcessClaim()
        ...
        private void init()
        {
            ...
            sql = @"select 
		                ...
		                ,claimFor 
                    from medicalClaim
                    where claimStatus='Requested' or ClaimStatus='On Process'";
        ...
        private string load_report(string table_name, string sql, String[,] matgrid, string[,] matfilter, String sortd, string sortby, int _page, int page_size)
        {
            ...
            string thisPage = "ProcessClaim.aspx?sortd=" + sortd + "&sortby={sortby}";
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                //html.Append("<td><a href=\"/MedicalClaim/ManageClaim.aspx?Id=" + dr["ID"] + "\">View</a></td>");
                html.Append("<td class=\"text-center\"><a class=\"tool btn btn-primary btn-xs\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"View\" href=\"/MedicalClaim/ManageClaim.aspx?Id=" + dr["ID"] + "\"><i class=\"fa fa-eye\"></i></a></td>");
