    ...
    public partial class List : BasePage
    {
        ...
        private void init()
        {
            String[,] matfilter = new String[,]{  
                        {"GroupName",    "Group Name",         "LT"},   
                    };

            //column type : T = text , M = Money, D = date , I = image
            String[,] matgrid = new String[,]{
                        {"GroupId",       "Group Id",        "200",      "T"},
                        {"GroupName",            "Group Name",             "200",      "T"},
            ...
            string table_name = "MsgPortalGrp";

            String sql = "SELECT * FROM dbo.MsgPortalGrp";
        ...
        private string load_report(string table_name, string sql, String[,] matgrid, string[,] matfilter, String sortd, string sortby, int _page, int page_size)
        {
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                html.Append("<td class=\"text-center\"><a class=\"tool btn btn-primary btn-xs\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"View\" href=\"/MessagingPortal/ManageGroup.aspx?groupId="+dr["GroupId"].ToString()+"\"><i class=\"fa fa-eye\"></i></a></td>");
                html.Append("</tr>");
            }
            ...
            string navigation_bar = get_paging_block(total_record, _page, page_size, true, "/MessagingPortal/ManageGroup.aspx");
