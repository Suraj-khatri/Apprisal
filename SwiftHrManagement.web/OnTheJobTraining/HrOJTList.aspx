<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/SwiftHRManager.Master" CodeBehind="HrOJTList.aspx.cs" Inherits="SwiftHrManagement.web.OnTheJobTraining.HrOJTList" %>
...
<table width="100%">
                        ...
                        <tr>
                            <td align="left" class="wellcome" valign="bottom">
                                <img src="../Images/big_bullit.gif" />&nbsp;On The Job Training/ Buddy System Feedbacks
                            </td>
                        </tr>
                        <tr>
