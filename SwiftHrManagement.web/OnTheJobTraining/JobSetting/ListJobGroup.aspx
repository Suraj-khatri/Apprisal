<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/SwiftHRManager.Master" CodeBehind="ListJobGroup.aspx.cs" Inherits="SwiftHrManagement.web.OnTheJobTraining.JobSetting.ListJobGroup" %>
...
<table width="100%">
                        <tr>
                            <td align="left" class="wellcome" valign="bottom">
                                <img src="../../Images/big_bullit.gif" />&nbsp;Job Group Details
                            </td>
                        </tr>
                        <tr>
