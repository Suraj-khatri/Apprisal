...
{
    public partial class ListJobGroup : BasePage
    {
           clsDAO _clsDao = null;
        ...
        private void init()
        {
            ...
            String[,] matfilter = new String[,]{
                        {"GROUP_NAME",    "Group Name",         "LT"},
                        {"DEPT_ID",    "Dept Name",         "LT"},
            ...
            String[,] matgrid = new String[,]{ 
                        ...
                        {"DEPT_ID",        "Dept Name",        "200",      "T"},
                        {"POSITION_ID",        "Post",        "200",      "T"},
                       
                        };

            string sortby = "JOB_GROUP_ID";
            string table_name = "JOBGROUP";

            String sql = "";
            sql = " SELECT JOB_GROUP_ID,GROUP_NAME,dbo.GetDeptName(DEPT_ID)[DEPT_ID],SD.DETAIL_TITLE  [POSITION_ID]" 
                    +" FROM JOBGROUP JG INNER JOIN StaticDataDetail SD ON JG.POSITION_ID=SD.ROWID WHERE 1=1";
        ...
        private string load_report(string table_name, string sql, String[,] matgrid, string[,] matfilter, String sortd, string sortby, int _page, int page_size)
        {
            ...
            string thisPage = "ListJobGroup.aspx?sortd=" + sortd + "&sortby={sortby}";
           ...
           html.Append("<th Class=\"HeaderStyle\" align=\"left\">Select</th>");
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                html.Append("<td><a href=\"/OnTheJobTraining/JobSetting/ManageJobGroup.aspx?Job_Group_Id=" + dr["JOB_GROUP_ID"] + "\">View</a></td>");
                html.Append("<td><a href=\"/OnTheJobTraining/JobSetting/ManageAssignJob.aspx?Job_Group_Id=" + dr["JOB_GROUP_ID"] + "\">Assign Job</a></td>");
            ...
            string navigation_bar = get_paging_block(total_record, _page, page_size, true, "/OnTheJobTraining/JobSetting/ManageJobGroup.aspx");
