<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/SwiftHRManager.Master" CodeBehind="ListOJT.aspx.cs" Inherits="SwiftHrManagement.web.OnTheJobTraining.ListOJT" %>
...
<table width="100%">
                        <tr>
                            <td align="left" class="wellcome" valign="bottom">
                                <img src="../Images/big_bullit.gif" />&nbsp;On The Job Training/ Buddy System Detail List
                            </td>
                        </tr>
                        <tr>
