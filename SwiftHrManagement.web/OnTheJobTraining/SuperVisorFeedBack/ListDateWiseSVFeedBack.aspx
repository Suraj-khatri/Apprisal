<%@ Page Language="C#" MasterPageFile="~/SwiftHRManager.Master" AutoEventWireup="true" CodeBehind="ListDateWiseSVFeedBack.aspx.cs" Inherits="SwiftHrManagement.web.OnTheJobTraining.SuperVisorFeedBack.ListDateWiseSVFeedBack" %>
...
<table width="100%">
                        ...
                        <tr>
                            <td align="left" class="wellcome" valign="bottom">
                                <img src="../../Images/big_bullit.gif" />&nbsp;OJT/Buddy System Feedbacks
                            </td>
                        </tr>
                        <tr>
