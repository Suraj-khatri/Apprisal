<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/SwiftHRManager.Master" CodeBehind="ListSuperVisorFeedBack.aspx.cs" Inherits="SwiftHrManagement.web.OnTheJobTraining.SuperVisorFeedBack.ListSuperVisorFeedBack" %>
...
<table width="100%">
                        ...
                        <tr>
                            <td align="left" class="wellcome" valign="bottom">
                                <img src="../../Images/big_bullit.gif" />&nbsp;OJT/Buddy System List for Feedback 
                            </td>
                        </tr>
                        <tr>
