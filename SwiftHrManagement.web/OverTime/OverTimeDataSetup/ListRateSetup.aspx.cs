...
namespace SwiftHrManagement.web.OverTime.OverTimeDataSetup
{
    public partial class ListRateSetup :BasePage
    {
        ...
        private void init()
        {
            ...
            string sortby = "ot_rate_id ";
            string table_name = "OtRateSetUp";

            String sql = "";



            sql = "select ot_rate_id,description,rate_type,dbo.ShowDecimal(amount)[amount] from OtRateSetUp where 1=1";
        ...
        private string load_report(string table_name, string sql, String[,] matgrid, string[,] matfilter, String sortd, string sortby, int _page, int page_size)
        {
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                html.Append("<td><a class=\"text-center\"><a class=\"tool btn btn-primary btn-xs\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"View\" href=\"/OverTime/OverTimeDataSetup/ManageOtRateSetUp.aspx?Rate_Id=" + dr["ot_rate_id"] + "\"><i class=\"fa fa-eye\"></i></a></td>");
                html.Append("</tr>");
            }
            ...
            string navigation_bar = get_paging_block(total_record, _page, page_size, true, "/OverTime/OverTimeDataSetup/ManageOtRateSetUp.aspx");
