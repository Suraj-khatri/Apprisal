    ...
    public partial class list : BasePage
    {
        ...
        private void init()
        {
            ...
            sql = "select SUM(no_of_request) as [no_of_request],ot.requested_by,ot.requested_id,ot.requesting_type,ot.reqType_id from "
               ...
               + "  where approved_date IS NULL AND requested_with = " + filterstring(ReadSession().Emp_Id.ToString())
        ...
        private string load_report(string table_name, string sql, String[,] matgrid, string[,] matfilter, String sortd, string sortby, int _page, int page_size)
        {
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                html.Append("<td class=\"text-center\"><a class=\"tool btn btn-primary btn-xs\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"View\" href=\"/OverTime/SuperVisorAppoveOT/ListDetails.aspx?Id=" + dr["requested_id"] + "&RType=" + dr["reqType_id"] + "\"><i class=\"fa fa-eye\"></i></a></td>");
                html.Append("</tr>");
            }
