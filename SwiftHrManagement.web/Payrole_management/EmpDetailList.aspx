<%@ Page Title="Swift HRM" Language="C#" MasterPageFile="~/SwiftHRManager.Master" AutoEventWireup="true" CodeBehind="EmpDetailList.aspx.cs" Inherits="SwiftHrManagement.web.Payrole_management.EmpDetailList" %>
...
<table width="100%">
        <tr>
            <td align="left" class="wellcome" valign="bottom">
                <img src="../../Images/big_bullit.gif" />&nbsp;&nbsp;Employee Information Details View
            </td>
        </tr>
        <tr>
