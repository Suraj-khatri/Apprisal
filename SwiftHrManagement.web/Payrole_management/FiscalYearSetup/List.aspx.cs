    ...
    public partial class List : BasePage
    {
        ...
        private void init()
        {
            ...
            String[,] matfilter = new String[,]{
                        {"FISCAL_YEAR_ENGLISH",   "FISCAL_YEAR_ENGLISH",       "LT"},
                        {"FISCAL_YEAR_NEPALI",    "FISCAL_YEAR_NEPALI",        "LT"},
                        {"EN_YEAR_START_DATE",    "EN_YEAR_START_DATE",        "LT"},
                        {"EN_YEAR_END_DATE",      "EN_YEAR_END_DATE",          "LT"}
                    };
            //column type : T = text , M = Money, D = date , I = image
            String[,] matgrid = new String[,]{
                        {"FISCAL_YEAR_ENGLISH",      "Fiscal Year English",     "200",      "LT"},
                        {"FISCAL_YEAR_NEPALI",       "Fiscal Year Nepali",      "200",      "LT"},
                        {"EN_YEAR_START_DATE",       "Eng. Year Start Date",    "200",      "D"},
                        {"EN_YEAR_END_DATE",         "Eng. Year End Date",      "200",      "D"},  
                        {"FLAG",                     "Is Default",              "200",      "D"},  
                        };
            string sortby = "FISCAL_YEAR_ID";
            string table_name = "FiscalYear";

            String sql = @"SELECT FISCAL_YEAR_ID, FISCAL_YEAR_ENGLISH, FISCAL_YEAR_NEPALI, CONVERT(VARCHAR,EN_YEAR_START_DATE,107) as 
             'EN_YEAR_START_DATE', CONVERT(VARCHAR,EN_YEAR_END_DATE,107) as 'EN_YEAR_END_DATE',CASE WHEN FLAG ='True' then 'Yes' WHEN 
             FLAG ='False' then 'No' end 'FLAG' FROM FiscalYear WHERE 1=1";
        ...
        private string load_report(string table_name, string sql, String[,] matgrid, string[,] matfilter, String sortd, string sortby, int _page, int page_size)
        {
            ...
            //html.Append("<th Class=\"HeaderStyle\" align=\"left\">Education</th>");
            //html.Append("<th Class=\"HeaderStyle\" align=\"left\">Medical</th>");
            //html.Append("<th Class=\"HeaderStyle\" align=\"left\">Identification</th>");
            //html.Append("<th Class=\"HeaderStyle\" align=\"left\">Family Member</th>");
            //html.Append("<th Class=\"HeaderStyle\" align=\"left\">Upload File</th>");
            //html.Append("<th Class=\"HeaderStyle\" align=\"left\">Training</th>");
            html.Append("</tr>");
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                html.Append("<td class=\"text-center\"><a class=\"tool btn btn-primary btn-xs\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"View\" href=\"/Payrole_management/FiscalYearSetup/Manage.aspx?ID=" + dr["FISCAL_YEAR_ID"] + "\"><i class=\"fa fa-eye\"></i></a></td>");

               // html.Append("<td><a href=\"/Payrole_management/FiscalYearSetup/Manage.aspx?ID=" + dr["FISCAL_YEAR_ID"] + "\">View</a></td>");
            }
            ...
            string navigation_bar = get_paging_block(total_record, _page, page_size, true, "/Payrole_management/FiscalYearSetup/Manage.aspx");
