    ...
    public partial class List : BasePage
    {
        ...
        private void init()
        {
            ...
            String[,] matfilter = new String[,]{
                            {"EMP_CODE", "Emp Code", "LT"},
                            {"dbo.GetEmployeeFullNameOfId(b.EMPLOYEE_ID)", "Employee Name", "LT"},
                            {"FY_ID", "Fiscal Year", "LT"},
                            {"dbo.GetDetailTitle(App_Rating)", "Appraisal Rating", "LT"},
                            {"Grade_Year", "Grade", "LT"},
                            {"dbo.GetEmployeeFullNameOfId(a.Created_By)", "Created By", "LT"}
...
,convert(varchar,a.Created_Date,101) CreatedDate,dbo.ShowDecimal(old_basic) OldBasic
 from Grade a inner join Employee b on a.Emp_Id=b.EMPLOYEE_ID";
