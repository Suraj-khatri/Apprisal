    ...
    public partial class List : BasePage
    {
        ...
        private void init()
        {
            ...
            String sql = "select s.ID, e.EMPLOYEE_ID,FIRST_NAME + ' ' + MIDDLE_NAME + ' ' + LAST_NAME AS EmpName, dbo.showdecimal(TotalSalary) 'TotalSalary', "
                + " dbo.showdecimal(Deduction) 'Deduction', dbo.showdecimal(Tax) 'Tax' from SalarySheet s, Employee e where s.EMPLOYEE_ID = e.EMPLOYEE_ID and FISCAL_YEAR_ID ='" + hdnfy.Value + "' and Month_Number ='" + hdnmonth.Value + "'";
