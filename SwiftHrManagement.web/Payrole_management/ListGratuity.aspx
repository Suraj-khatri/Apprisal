<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/SwiftHRManager.Master" CodeBehind="ListGratuity.aspx.cs" Inherits="SwiftHrManagement.web.Payrole_management.ListGratuity" %>
    ...
    <table width="100%">
                        <tr>
                            <td align="left" class="wellcome" valign="bottom">
                                <img src="../../Images/big_bullit.gif"/>&nbsp;&nbsp; <a href="GratuitySetup/List.aspx" >Gratuity Master List</a> >> Gratuity Setup List
                            </td>
                        </tr>
                        <tr>
