...
{
    public partial class ListGratuity : BasePage
    {
        ...
        private void init()
        {
            ...
            String[,] matgrid = new String[,]{
                        ...
                        {"start_year",     "From Year",  "200",      "N"},
                        {"end_year",       "To Year",    "200",      "N"},
                        {"rate",           "Rate",        "200",      "M"}, 
            ...
            string sortby = "start_year";
            string table_name = "GratuitySetup";

            String sql = "";

            sql = "select id,start_year,end_year,rate from GratuitySetup where 1=1";
        ...
        private string load_report(string table_name, string sql, String[,] matgrid, string[,] matfilter, String sortd, string sortby, int _page, int page_size)
        {
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                html.Append("<td><a href=\"/Payrole_management/ManageGratuity.aspx?Id=" + dr["id"] + "\">View</a></td>");
            ...
            string navigation_bar = get_paging_block(total_record, _page, page_size, true, "/Payrole_management/ManageGratuity.aspx");
