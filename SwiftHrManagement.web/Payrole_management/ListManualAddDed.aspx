<%@ Page Title="" Language="C#" MasterPageFile="~/SwiftHRManager.Master" AutoEventWireup="true" CodeBehind="ListManualAddDed.aspx.cs" Inherits="SwiftHrManagement.web.Payrole_management.ListManualAddDed" %>
...
<table width="100%">
        <tr>
            <td align="left" class="wellcome" valign="bottom">
                <img src="../../Images/big_bullit.gif" />&nbsp;Manual Head Addition Deduction
            </td>
        </tr>
        <tr>
