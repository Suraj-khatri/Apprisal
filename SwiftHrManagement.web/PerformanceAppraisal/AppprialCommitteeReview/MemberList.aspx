<%@ Page Title="" Language="C#" MasterPageFile="~/SwiftHRManager.Master" AutoEventWireup="true" CodeBehind="MemberList.aspx.cs" Inherits="SwiftHrManagement.web.PerformanceAppraisal.AppprialCommitteeReview.MemberList" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script language="javascript" type="text/javascript">

    function deleteMembers(_obj) {
                ...
                <div class="col-md-12 col-sm-12">
                    <section class="panel">
                        ...
                        <div>
                            ...
                            <asp:Button ID="btnDelete" runat="server" Text="Button" style="display:none" onclick="Button1_Click"/>
                        </div>                        
                    </section>
                </div>
            </div>
