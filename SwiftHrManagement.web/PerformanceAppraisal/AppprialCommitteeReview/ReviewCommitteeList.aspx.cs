...
{
    public partial class ReviewCommitteeList : BasePage
    {
         RoleMenuDAOInv _roleMenuDao = null;
         PerformanceAppraisalDAO _obj = new PerformanceAppraisalDAO();
        public ReviewCommitteeList()
        {
        ...
        private void init()
        {
            ...
            String[,] matgrid = new String[,]{
                        {"reviewType",            "Type",             "200",      "T"},                        
                        {"isActive",                "Status",             "200",      "T"},                        
                        };



            string sortby = "ID";
            string table_name = "appriasalReviewCommittee";

            String sql = "";

            sql = "Select rowId as ID,reviewType,case when isnull(isActive,'Y')='Y' then 'Active' else 'InActive' end as isActive from appriasalReviewCommittee where 1=1";
        ...
        private string load_report(string table_name, string sql, String[,] matgrid, string[,] matfilter, String sortd, string sortby, int _page, int page_size)
        {
            ...
            html.Append("<th Class=\"HeaderStyle\" align=\"center\">Actions</th>");
            html.Append("</tr>");
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                html.Append("<td class=\"text-center\"><a class=\"tool btn btn-primary btn-xs\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Add Position\" href=\"/PerformanceAppraisal/AppprialCommitteeReview/AddMemberType.aspx?Id=" + dr["ID"] + "\"><i class=\"fa fa-plus\"></i></a>");
                html.Append("<a class=\"tool btn btn-primary btn-xs\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"View Members\" href=\"/PerformanceAppraisal/AppprialCommitteeReview/MemberList.aspx?Id=" + dr["ID"] + "\"><i class=\"fa fa-eye\"></i></a>");
                html.Append("<a class=\"tool btn btn-primary btn-xs\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Edit\" href=\"/PerformanceAppraisal/AppprialCommitteeReview/AddMemberType.aspx?editId=" + dr["ID"] + "\"><i class=\"fa fa-pencil\"></i></a></td>");
            ...
            string navigation_bar = get_paging_block(total_record, _page, page_size, true, "AddMemberType.aspx");
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            var dt = _obj.deleteCommittee(id,ReadSession().Emp_Id.ToString());
            if (dt.Rows.Count <= 0)
                return;
