...
namespace SwiftHrManagement.web.PeoformanceAppraisal.AppraisalFeedback
{
    public partial class List : BasePage
    {
        ...
        private void init()
        {
            ...
            String[,] matfilter = new String[,]{  
                        {"E.FIRST_NAME",    "Emp First Name",         "LT"},   
            ...
            String[,] matgrid = new String[,]{
                        ...
                        {"TO_DATE",    "To Date",     "200",      "D"},
                         {"DETAILS",    "Appraisal Details",     "200",      "T"}
                        };
            ...
            sql = "SELECT AP.ID,AP.EMPLOYEE_ID,CONVERT(VARCHAR,AP.FROM_DATE,107) AS FROM_DATE,CONVERT(VARCHAR,AP.TO_DATE,107) AS TO_DATE,"
                    +" AP.TITLE, AP.DETAILS, E.FIRST_NAME + ' ' + E.MIDDLE_NAME + ' ' + E.LAST_NAME AS "
        ...
        private string load_report(string table_name, string sql, String[,] matgrid, string[,] matfilter, String sortd, string sortby, int _page, int page_size)
        {
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                html.Append("<td><a href=\"/PerformanceAppraisal/AppraisalFeedback/AppraisalView.aspx?Id=" + dr["ID"] + "\">Appraisal</a></td>");
                html.Append("<td><a href=\"/PerformanceAppraisal/AppraisalFeedback/FeedbackList.aspx?Id=" + dr["ID"] + "&EmpId=" + dr["EMPLOYEE_ID"] + "\">Feedback</a></td>");
                html.Append("</tr>");
            }
