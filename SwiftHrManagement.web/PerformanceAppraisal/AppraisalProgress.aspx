<%@ Page Title="" Language="C#" MasterPageFile="~/SwiftHRManager.Master" AutoEventWireup="true" CodeBehind="AppraisalProgress.aspx.cs" Inherits="SwiftHrManagement.web.PerformanceAppraisal.AppraisalProgress" %>
...
<table width="100%">
                        <tr>
                            <td align="left" class="wellcome" valign="bottom">
                                <img src="../Images/big_bullit.gif"/>&nbsp;&nbsp; Employee Appraisal Progress
                            </td>
                        </tr>
                        <tr>
