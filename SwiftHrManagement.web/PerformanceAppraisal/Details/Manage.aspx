<%@ Page Title="Swift HRM" Language="C#" MasterPageFile="~/ProjectMaster.Master" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="SwiftHrManagement.web.PerformanceAppraisal.Details.Manage" %>
            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    ...
                    <div class="col-md-8 form-group autocomplete-form">
                        ...
                        <asp:TextBox ID="txtEmp" runat="server" CssClass="form-control" AutoPostBack="true" AutoComplete="Off" 
                            ontextchanged="txtEmp_TextChanged">
                        </asp:TextBox>
                        <cc1:TextBoxWatermarkExtender ID="TextBoxWatermarkExtender1" 
                            runat="server" Enabled="True" TargetControlID="txtEmp" 
                    ...
                    <div class="col-md-4 form-group">
                        <label>Days:<span class="errormsg">*</span></label>
                         <asp:RequiredFieldValidator 
                                ...
                                ControlToValidate="txtSelfDays" Display="Dynamic" ErrorMessage="Required" 
                                ValidationGroup="evaluate"></asp:RequiredFieldValidator>
                    ...
                    <div class="col-md-4 form-group">
                        ...
                        <asp:RequiredFieldValidator ID="rfv" runat="server" ControlToValidate="TxtTodate" Display="Dynamic" 
                            ErrorMessage="Required" ValidationGroup="evaluate" SetFocusOnError="True">
                        </asp:RequiredFieldValidator>
                        <asp:CompareValidator ID="CompareValidator3" runat="server" 
                                ...
                                ValidationGroup="evaluate" Display="Dynamic" Type="Date">
                    ...
                    <div class="col-md-4 form-group">
                        ...
                        <asp:TextBox ID="TxtDateOfAppoinment" runat="server" CssClass="form-control" Enabled="false" 
                            ValidationGroup="evaluate"></asp:TextBox>
                        <cc1:CalendarExtender ID="CalendarExtender2" runat="server" 
                            Enabled="True" TargetControlID="TxtDateOfAppoinment">
                        </cc1:CalendarExtender>
                    </div>
                              </div>
                          <div class="row">
                    <div class="col-md-4 form-group">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="DdlPositionAtAppointment" 
                            Display="Dynamic" ErrorMessage="Required" ValidationGroup="evaluate" SetFocusOnError="True">
                        </asp:RequiredFieldValidator> 
                        <asp:DropDownList ID="DdlPositionAtAppointment" runat="server" CssClass="form-control" ValidationGroup="evaluate">
                        </asp:DropDownList>
                    </div>
                    <div class="col-md-4 form-group">
                    ...
                    <div class="col-md-4 form-group">
                        <label>Probation Period To:</label>
                         ...
                         <cc1:CalendarExtender ID="CalendarExtender3" runat="server" 
                            Enabled="True" TargetControlID="TxtPrbPrdToDate">
                        </cc1:CalendarExtender>
                    </div>
                              </div>
                          <div class="row">
                    ...
                    <div class="col-md-8 form-group autocomplete-form">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtSup" 
                            Display="Dynamic" ErrorMessage="Required" ValidationGroup="evaluate"></asp:RequiredFieldValidator>
                    ...
                    <div class="col-md-4 form-group">
                        <label>Days:<span class="errormsg">*</span></label>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtSupDays" 
                            Display="Dynamic" ErrorMessage="Required" ValidationGroup="evaluate"></asp:RequiredFieldValidator>
                    ...
                    <div class="col-md-8 form-group autocomplete-form">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtReviewer" 
                            Display="Dynamic" ErrorMessage="Required" ValidationGroup="evaluate"></asp:RequiredFieldValidator>
                        ...
                        <cc1:TextBoxWatermarkExtender ID="TextBoxWatermarkExtender3" runat="server" Enabled="True" 
                            TargetControlID="txtReviewer" WatermarkCssClass="form-control" WatermarkText="Auto Complete">
                        </cc1:TextBoxWatermarkExtender>
                    ...
                    <div class="col-md-4 form-group">
                        <label>Days:<span class="errormsg">*</span></label>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtRevDays" 
                            Display="Dynamic" ErrorMessage="Required" ValidationGroup="evaluate"></asp:RequiredFieldValidator>
