...
namespace SwiftHrManagement.web.PerformanceAppraisal.Details
{
    public partial class SelfInitiation : BasePage
    {
        ...
        private void getPopulateDataByEmpID()
        {
            ...
            CLSDao.CreateDynamicDDl(DdlPositionAtAppointment, " Exec procManageAppraisal 'AP',@EmpId= '" + hdnEmpId.Value + "'", "POSITION_ID", "POSITION", "", "Select");
        ...
        protected void BtnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Response.Redirect("SelftInitiationList.aspx");
        ...
        {
            Response.Redirect("SelftInitiationList.aspx?&masterpage=" + Getmasterpage() + " ");
        }
        ...
        public void LoadSelfInitiation()
        {
            LblMsg.Text = "";
           var empName =  CLSDao.GetSingleresult("SELECT dbo.GetEmployeeInfoById(" + filterstring(ReadSession().Emp_Id.ToString()) + ")");
           txtEmp.Text = empName;
            hdnEmpId.Value = ReadSession().Emp_Id.ToString();
