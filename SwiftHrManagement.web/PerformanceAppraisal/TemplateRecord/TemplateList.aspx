<%@ Page Title="" Language="C#" MasterPageFile="~/SwiftHRManager.Master" AutoEventWireup="true" CodeBehind="TemplateList.aspx.cs" Inherits="SwiftHrManagement.web.PerformanceAppraisal.TemplateRecord.TemplateList" %>
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <section class="panel">
                        <div class="panel-body">
                            <div id="rptTemplate" runat="server">	
                            </div>   
