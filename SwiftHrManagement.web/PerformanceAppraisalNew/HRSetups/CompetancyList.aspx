<%@ Page Title="" Language="C#" MasterPageFile="~/Apprisal.Master" AutoEventWireup="true" CodeBehind="CompetancyList.aspx.cs" Inherits="SwiftHrManagement.web.PerformanceAppraisalNew.HRSetups.CompetancyList" %>
    ...
    <div class="panel">
        <header class="panel-heading">
            <i class="fa fa-caret-right"></i>   
                Level Setup  <a class="pull-right btn btn-primary btn-xs" href="/PerformanceAppraisalNew/HRSetups/CompetancyManage.aspx"> <i class="fa fa-plus-circle" ></i>  Add New Level</a>
        </header>
