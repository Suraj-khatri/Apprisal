...
namespace SwiftHrManagement.web.PerformanceAppraisalNew.HRSetups
{
    public partial class LevelCompetencyMatrixSetup : BasePage
    {
        ...
        {
            var dt = _appraisal.LoadLevelName(GetStatic.ReadQueryString("DepartId", ""));
            var comMatrixName = "";
        ...
        private void LoadGrid()
        {
            ...
            var dt = _Obj.GetLevelAppraisalMatrixDetails(GetStatic.ReadQueryString("DepartId", ""));
        ...
        protected void saveBtn_Click(object sender, EventArgs e)
        {
            ...
            var res = _Obj.EditLevelKriKpiData(kraTopic, kraWeight, kpiTopic, kpiWeight, ReadSession().Emp_Id.ToString(), filterstring(hdnId2.Value), GetStatic.ReadQueryString("DepartId", ""), GetStatic.ReadQueryString("DepartId", ""));
        ...
        protected void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                GetStatic.AlertMessage(this, "You cannot enter Kpi more than kra");
                return;
            }
            var res = _Obj.UpdateLevelKriKpi(ReadSession().Emp_Id.ToString(), kraTopic.Text, kraWeight.Text, kpiTopic.Text, kpiWeight.Text, GetStatic.ReadQueryString("DepartId", ""), GetStatic.ReadQueryString("DepartId", ""));
            if (res.ErrorCode == "0")
            {
                GetStatic.SweetAlertSuccessMessage(this, "Success", res.Msg);
                hdnId2.Value = "";
