...
{
    public partial class SearchPerformanceAgreement : BasePage
    {
        RoleMenuDAOInv _RoleMenuDAOInv = null;
        public SearchPerformanceAgreement()
        {
        ...
        private void init()
        {
            ...
            String sql = "";
             ...
             sql = @"Select * from (SELECT  DISTINCT AI.employeeId AS EMPLOYEE_ID ,
                    ...
                    AND rl.Active <> 'N'
                    AND  AI.STATUS in(1,2,3,4,10,14,12) 
                    )as X Where 1=1 ";
        ...
        private string load_report(string table_name, string sql, String[,] matgrid, string[,] matfilter, String sortd, string sortby, int _page, int page_size)
        {
            ...
            string thisPage = "SearchPerformanceAgreement.aspx?sortd=" + sortd + "&sortby={sortby}";
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                html.Append("<td class=\"text-center\"><a class=\"tool btn btn-primary btn-xs\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"View\" href=\"KRAKPI.aspx?appId=" + Uri.EscapeDataString(Crypto(dr["appraisalId"].ToString())) + "&empId=" + Uri.EscapeDataString(Crypto(dr["EMPLOYEE_ID"].ToString())) + "\"><i class=\"fa fa-eye\"></i></a>");
