<%@ Page Language="C#" MasterPageFile="~/SwiftHRManager.Master" AutoEventWireup="true" CodeBehind="ManageAppraisalReport.aspx.cs" Inherits="SwiftHrManagement.web.Report.AppraisalSummary.ManageAppraisalReport" Title="" %>
                    ...
                    <section class="panel">     
                        ...
                        <div class="panel-body">     
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" Enabled="true" 
                                    ControlToValidate="txtFromDate" ErrorMessage="Required" SetFocusOnError="true" 
                            ...
                            <div class="form-group">
                                ...
                                <asp:RequiredFieldValidator ID="rfv1" runat="server" Enabled="true"  ValidationGroup="appraisal" ControlToValidate="txtToDate"
