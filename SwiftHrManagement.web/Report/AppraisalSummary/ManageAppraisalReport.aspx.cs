...
{
    public partial class ManageAppraisalReport : BasePage
    {
        clsDAO CLsDAo = null;
        RoleMenuDAOInv _roleMenuDao = null;
        PerformanceAppraisalDAO _performanceAppDao = null;

        public ManageAppraisalReport()
        {
            CLsDAo = new clsDAO();
        ...
        {
            Response.Redirect("ViewAppraisalReport.aspx?branch_id=" + DdlBranchName.Text + "&department_id=" + DdlDeptName.Text + "&emp_id=" + ddlEmpName.Text + "&from_date=" + txtFromDate.Text + "&to_date=" + txtToDate.Text + "");
        }
