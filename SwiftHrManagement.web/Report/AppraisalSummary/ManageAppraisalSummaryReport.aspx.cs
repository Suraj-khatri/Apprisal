...
{
    public partial class ManageAppraisalSummaryReport : BasePage
    {
       clsDAO CLsDAo = null;
        RoleMenuDAOInv _roleMenuDao = null;
        PerformanceAppraisalDAO _performanceAppDao = null;

        public ManageAppraisalSummaryReport()
        {
            CLsDAo = new clsDAO();
        ...
        {
            Response.Redirect("appraisalSummaryReport.aspx?branch_id=" + DdlBranchName.Text + "&department_id=" + DdlDeptName.Text + "&emp_id=" + ddlEmpName.Text + "&from_date=" + txtFromDate.Text + "&to_date=" + txtToDate.Text + "");
        }
