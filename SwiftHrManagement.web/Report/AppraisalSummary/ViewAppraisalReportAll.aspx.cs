...
{
    public partial class ViewAppraisalReportAll : BasePage
    {
        ...
        private void loadReport()
        {
            ...
            //if (emp_id == "")
            //{
            dt = _arDao.GetBranchReportAll(branch_id, department_id, emp_id, from_date, to_date);
            //}
            //else
            //{
