...
{
    public partial class viewAppraisalFinalReport : BasePage
    {
        ...
        public viewAppraisalFinalReport()
        {
        ...
        private void loadReport()
        {
            ...
            //if (emp_id == "")
            //{
            dt = _arDao.GetBranchReportFinal(branch_id, department_id, emp_id, from_date, to_date);
            //}
            //else
            //{
