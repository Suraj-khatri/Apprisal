...
{
    public partial class ExportExceldepMonthlyRpt : BasePage
    {
        ClsDAOInv _clsdao = null;
        string sql = "";

        public ExportExceldepMonthlyRpt()
        {
        ...
        private void getActiveAssetRpt()
        {
            ...
            double tot_cost = 0.00, acc_dep = 0.00, shawan = 0.00, bhadra = 0.00, ashoj = 0.00, kartik = 0.00, mangshir = 0.00, poush = 0.00,
            ...
            int cols = dt.Columns.Count;
            {
                ...
                foreach (DataRow row in dt.Rows)
                {
                    ...
                    shawan = shawan + double.Parse(row[4].ToString());
                    bhadra = bhadra + double.Parse(row[5].ToString());
                    ashoj = ashoj + double.Parse(row[6].ToString());
                    kartik = kartik + double.Parse(row[7].ToString());
                    mangshir = mangshir + double.Parse(row[8].ToString());
                    poush = poush + double.Parse(row[9].ToString());
                    magh = magh + double.Parse(row[10].ToString());
                    falgun = falgun + double.Parse(row[11].ToString());
                    chaitra = chaitra + double.Parse(row[12].ToString());
                    baishak = baishak + double.Parse(row[13].ToString());
                    jestha = jestha + double.Parse(row[14].ToString());
                    asad = asad + double.Parse(row[15].ToString());
                    closing_cost = closing_cost + double.Parse(row[16].ToString());
                }
                str.Append("<tr>");
        ...
        private void getINTransferedRpt()
        {
            ...
            StringBuilder str1 = new StringBuilder("<table border=\"0\" class=\"TBL\" cellpadding=\"5\" cellspacing=\"5\" align=\"left\">");
        ...
        private void getInactiveAssetRpt()
        {
            ...
            StringBuilder str2 = new StringBuilder("<table border=\"0\" class=\"TBL\" cellpadding=\"5\" cellspacing=\"5\" align=\"left\">");
        ...
        private void getOutTransferedAssetRpt()
        {
            ...
            StringBuilder str3 = new StringBuilder("<table border=\"0\" class=\"TBL\" cellpadding=\"5\" cellspacing=\"5\" align=\"left\">");
        ...
        private void getSoldAssetRpt()
        {
            ...
            StringBuilder str4 = new StringBuilder("<table border=\"0\" class=\"TBL\" cellpadding=\"5\" cellspacing=\"5\" align=\"left\">");
        ...
        private void getWriteoffAssetRpt()
        {
            ...
            StringBuilder str5 = new StringBuilder("<table border=\"0\" class=\"TBL\" cellpadding=\"5\" cellspacing=\"5\" align=\"left\">");
