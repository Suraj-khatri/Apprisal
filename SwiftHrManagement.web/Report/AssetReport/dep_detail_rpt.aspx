<%@ Page Language="C#" MasterPageFile="~/SwiftHRManager.Master" AutoEventWireup="true" CodeBehind="dep_detail_rpt.aspx.cs" Inherits="SwiftHrManagement.web.Report.AssetReport.dep_detail_rpt" %>
            ...
            <tr>
                <td colspan="2" style="text-align: center"><div id="divCompany" class="ReportHeader" runat="server"></div>
                    <div class="ReportSubHeader">
                        <b>Asset Group Wise Depreciation Report Details</b><br />
