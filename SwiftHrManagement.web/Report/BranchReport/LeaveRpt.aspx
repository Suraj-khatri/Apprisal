<%@ Page Title="" Language="C#" MasterPageFile="~/SwiftHRManager.Master" AutoEventWireup="true" CodeBehind="LeaveRpt.aspx.cs" Inherits="SwiftHrManagement.web.Report.BranchReport.LeaveRpt" %>
            ...
            <div align="center">
                <strong>
                    ...
                    <asp:Panel ID="summaryReport" runat="server">
                        <span>Leave Summary Report From: </span> 
