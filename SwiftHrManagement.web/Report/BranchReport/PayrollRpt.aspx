<%@ Page Title="" Language="C#" MasterPageFile="~/SwiftHRManager.Master" AutoEventWireup="true" CodeBehind="PayrollRpt.aspx.cs" Inherits="SwiftHrManagement.web.Report.BranchReport.PayrollRpt" %>
                    ...
                    <section class="panel">
                        <div class="panel-body">
                            <asp:HiddenField ID="year" runat="server" />
                                ...
                                <asp:HiddenField ID="emp_id" runat="server" />
