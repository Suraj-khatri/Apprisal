<%@ Page Title="" Language="C#" MasterPageFile="~/SwiftHRManager.Master" AutoEventWireup="true" CodeBehind="TrainingRpt.aspx.cs" Inherits="SwiftHrManagement.web.Report.BranchReport.TrainingRpt" %>
            ...
            <div align="center">
                <strong>
                    ...
                    <asp:Panel ID="summaryReport" runat="server">
                        <span>Training Participations Report From: </span> 
