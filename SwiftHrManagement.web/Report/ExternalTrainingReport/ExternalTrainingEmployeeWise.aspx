<%@ Page Title="" Language="C#" MasterPageFile="~/SwiftHRManager.Master" AutoEventWireup="true" CodeBehind="ExternalTrainingEmployeeWise.aspx.cs" Inherits="SwiftHrManagement.web.Report.ExternalTrainingReport.ExternalTrainingEmployeeWise" %>
...
<td>
            ...
            <div align="center">
                ...
                <asp:Label ID="Lbldatetype" runat="server"></asp:Label> Trainings Attended From: <asp:Label ID="DateFrom" runat="server">
                </asp:Label> To Date:
