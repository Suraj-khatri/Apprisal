...
{
    public partial class ExternalTrainingEmployeeWise : BasePage
    {
        clsDAO _clsdao = null;
        RoleMenuDAOInv _roleMenuDao = null;
        public ExternalTrainingEmployeeWise()
        {
         _clsdao = new clsDAO();
        ...
        private void loadReport()
        {
            ...
            DataTable dt = _clsdao.getDataset("exec [procExternalTrainingReport] 'e'," + filterstring(From) + "," + filterstring(To) + "," + filterstring(BranchId) + "," + filterstring(DeptId) + "," + filterstring(EmpId) + "," + filterstring(Train) + "").Tables[0];
