<%@ Page Title="" Language="C#" MasterPageFile="~/SwiftHRManager.Master" AutoEventWireup="true" CodeBehind="ExternalTrainingReport.aspx.cs" Inherits="SwiftHrManagement.web.Report.ExternalTrainingReport.ExternalTrainingReport" %>
			...
			<td valign="top">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<img src="/images/spacer.gif" width="5" height="1"><img src="/images/big_bullit.gif">&nbsp;&nbsp;Training Detail Report</td>
					</tr>
					<tr>
...
<!--################ START FORM STYLE-->
 <table class="container" border="0" cellpadding="0" cellspacing="0" width="40%">
  <tbody><tr>
    ...
    <td width="91%" class="container_tmid"><div>External Training Report</div></td>
...
<!--################ END FORM STYLE-->
 ...
 <table border="0" cellspacing="5" cellpadding="5" class="container">  
        ...
        <tr>            
            ...
            <td>
                <asp:TextBox ID="TxtFrmDate" runat="server" CssClass="inputTextBoxLP1"></asp:TextBox>
        ...
        <tr>
            <td nowrap="nowrap"><div align="right" class="text_form1">To Date :</div></td>
            <td>
        ...
        <tr>
            <td nowrap="nowrap"><div align="right" class="text_form1">Report Type :</div></td>
            <td>
                <asp:DropDownList ID="DdlReportType" runat="server" CssClass="FltCMBDesign" Width="150px">
                    <asp:ListItem Value="s">Summary Report</asp:ListItem>
                    <asp:ListItem Value="d">Detail Report</asp:ListItem>
                </asp:DropDownList>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <asp:Button ID="BtnViewRpt" runat="server" CssClass="button" 
                     Text="View Report" onclick="BtnViewRpt_Click" />
            </td>       
        </tr>
    </table>
...
<!--################ END FORM STYLE-->
   ...
   <!--Start Training Report Report-->
        ...
        <tr>
        <td width="1%" class="container_tl"><div></div></td>
        <td width="91%" class="container_tmid"><div>Training Report</div></td>
        <td width="8%" class="container_tr"><div></div></td>
        </tr>
        <tr>
        <td class="container_l"></td>
       ...
       <%-- <asp:RequiredFieldValidator 
        ...
        <tr>
           <td nowrap="nowrap"><div align="right" class="text_form1">Training Program :</div></td>
           <td>
        ...
        <td>                
        <asp:Button ID="Btn_ShowReport" runat="server" Text="Employee Wise" 
        CssClass="button" onclick="Btn_ShowReport_Click" ValidationGroup="Training" />
        <asp:Button ID="BtnTraing" runat="server" Text="Training Wise" 
        CssClass="button" onclick="BtnTraing_Click"  ValidationGroup="Training"  />
        </td>           
        </tr>
