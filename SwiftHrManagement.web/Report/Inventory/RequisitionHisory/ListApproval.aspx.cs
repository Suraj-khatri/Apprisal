...
{
    public partial class ListApproval : BasePage
    {
        ...
        private void init()
        {
            ...
            TxtAppMessage.Text = _clsdao.GetSingleresult("select Approver_message from IN_Requisition_Message where id = "+ hdnapid.Value +"");
