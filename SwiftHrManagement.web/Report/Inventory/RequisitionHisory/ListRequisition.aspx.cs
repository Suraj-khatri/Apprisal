...
{
    public partial class ListRequisition : BasePage
    {
        RoleMenuDAOInv _RoleMenuDAOInv = new RoleMenuDAOInv();
        ClsDAOInv _clsdao = null;
        public ListRequisition()
        {
        ...
        private void init()
        {
            ...
            TxtAppMessage.Text = _clsdao.GetSingleresult("select Requ_Message from IN_Requisition_Message where id = " + hdnapid.Value + "");
