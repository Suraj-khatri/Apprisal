<%@ Page Title="" Language="C#" MasterPageFile="~/SwiftHRManager.Master" AutoEventWireup="true" CodeBehind="ViewAcknowledged.aspx.cs" Inherits="SwiftHrManagement.web.Report.Inventory.RequisitionHisory.ViewAcknowledged" %>
                ...
                <div class="col-md-12 col-sm-12">
                    <section class="panel">
                        <div class="panel-body">
                            ...
                            <label>Acknowledged Message :</label>
                            <asp:Panel ID="PnApprove" runat="server" BorderStyle="None" CssClass="txtlbl">
                                <asp:TextBox ID="txtAckMsg" runat="server" CssClass="form-control" TextMode="MultiLine"></asp:TextBox>
                            </asp:Panel>
