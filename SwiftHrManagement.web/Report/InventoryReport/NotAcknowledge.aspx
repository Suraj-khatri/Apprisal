<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="NotAcknowledge.aspx.cs" Inherits="SwiftHrManagement.web.Report.InventoryReport.NotAcknowledge" %>
...
<table width="700px" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
    <td colspan="2" style="text-align: center"><div id="divCompany" class="ReportHeader" runat="server"></div>
                <div id="Div1" class="ReportSubHeader">Branch Wise Not Acknowledge<br />
