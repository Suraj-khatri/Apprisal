<%@ Page Title="" Language="C#"  AutoEventWireup="true" CodeBehind="ShowMonthEndRpt.aspx.cs" Inherits="SwiftHrManagement.web.Report.InventoryReport.ShowMonthEndRpt" %>
...
<table width="700px" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
    <td colspan="2" style="text-align: center"><div id="divCompany" class="ReportHeader" runat="server"></div>
                <div id="Div1" class="ReportSubHeader">Inventory Month End Report<br />
                    Branch Name: <asp:Label ID="LblBranchName" runat="server"></asp:Label>
                    
                    </div>
                    <div style="text-align: left" class="ReportSubHeader">
