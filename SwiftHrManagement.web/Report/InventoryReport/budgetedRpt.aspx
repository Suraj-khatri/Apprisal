<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="budgetedRpt.aspx.cs" Inherits="SwiftHrManagement.web.Report.InventoryReport.budgetedRpt" %>
...
<table width="700px" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
    <td colspan="2" style="text-align: center"><div id="divCompany" class="ReportHeader" runat="server"></div>
                <div id="Div1" class="ReportSubHeader">Budgeted Report <br />
                    Fical Year:<asp:Label ID="lblFy" runat="server"></asp:Label><br />
    ...
    <tr>
        <td colspan="2"><div id="rptDiv" runat="server"></div>
        &nbsp;</td>
    </tr>
    </table>
