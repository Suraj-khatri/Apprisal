...
{
    public partial class PayrollCalculationRptTrial : BasePage
    {
        clsDAO _clsdao = null;
        public PayrollCalculationRptTrial()
        {
            _clsdao = new clsDAO();
        }
        ...
        private void loadReport()
        {
            ...
            DataTable dt = _clsdao.getDataset("exec [procPayrollCalDetail_Trial] 'a'," + filterstring(year) + "," + filterstring(month) + "").Tables[0];
