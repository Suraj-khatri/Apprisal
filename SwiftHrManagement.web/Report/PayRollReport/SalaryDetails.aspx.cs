...
{
    public partial class SalaryDetails : BasePage
    {
        ...
        private void loadReport()
        {
            ...
            str.Append("<tr><td align=\"left\" class=\"border\"><b>Total Benifit</td><td class=\"border\" align=\"right\"><b> " + Benifit.ToString("0.00") + "</td></tr>");
