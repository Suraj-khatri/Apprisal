...
{
    public partial class TDSTReportEmployeeWise : BasePage
    {
        string currPage = "";
        ...
        private void loadReport()
        {
            ...
            DataTable dt = CLsDAo.getTable("Exec [procTDSEmployeeWiseReport] @flag='s',@year=" + filterstring(year) + ",@month=" + filterstring(month) + ",@EmpID=" + filterstring(empid) + ""
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                tot = tot + double.Parse(dr[1].ToString());
                str.Append("</tr>");
            }
             str.Append("<tr>" +
