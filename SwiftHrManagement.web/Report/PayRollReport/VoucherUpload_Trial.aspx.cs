...
{
    public partial class VoucherUpload_Trial : BasePage
    {
        clsDAO _clsdao = null;
        CompanyDAO _company = null;
        CompanyCore _CompanyCore = null;
        public VoucherUpload_Trial()
        {
            _clsdao = new clsDAO();
        ...
        void LoadHTML()
        {
            ...
            if (branch == "")
            {
                ...
                foreach (DataRow dr in dt1.Rows)
                {
                        ...
                        dt = _clsdao.getDataset("EXEC Proc_SalaryVoucher_trial @fiscalYear = " + filterstring(year) + ",@runmonth = " + filterstring(month) + ",@BRANCH_ID = " + filterstring(dr[0].ToString()) + "").Tables[0];
            ...
            else
            {
                ...
                dt = _clsdao.getDataset("EXEC Proc_SalaryVoucher_trial @fiscalYear = " + filterstring(year) + ",@runmonth = " + filterstring(month) + ",@BRANCH_ID = " + filterstring(branch) + "").Tables[0];
