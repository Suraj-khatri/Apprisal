<%@ Page Title="" Language="C#" MasterPageFile="~/SwiftHRManager.Master" AutoEventWireup="true" CodeBehind="YearlySalarySheetDetails.aspx.cs" Inherits="SwiftHrManagement.web.Report.PayRollReport.YearlySalarySheetDetails" %>
                    ...
                    <section class="panel">
                        <div class="panel-body">
                            <div class="text-center">
                                ...
                                <strong><span ><asp:Label ID="lblBranchName" runat="server"></asp:Label> </span></strong><br />   
                            </div>
