<%@ Page Language="C#" MasterPageFile="~/SwiftHRManager.Master" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="SwiftHrManagement.web.Report.SupervisorReport.Manage" %>
        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel">     
                <header class="panel-heading">
                    ...
                    &nbsp;Sub-Ordinate's Summary Report
                </header>
            </div>
            <div class="panel panel-default">
                <header class="panel-heading">
                    Sub-Ordinate's Report
                </header>
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Required!"
                             ControlToValidate="txtToDate" Display="Dynamic" SetFocusOnError="True" ValidationGroup="sup">
                    ...
                    <div class="form-group">
                        ...
                        <asp:Button ID="BtnPAppraisalRpt" runat="server" CssClass="btn btn-primary" Text="Appraisal Rpt" 
                            onclick="BtnPAppraisalRpt_Click"  ValidationGroup="sup"/> 
                    </div>
                </div>
            </div>
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <asp:Button ID="BtnSupRpt" runat="server" CssClass="btn btn-primary" Text="Export To Excel" 
                            ValidationGroup="payroll" onclick="BtnSupRpt_Click"/>        
                    </div>
                </div>
            </div>
        </div>
