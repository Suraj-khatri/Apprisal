<%@ Page Title="" Language="C#" MasterPageFile="~/SwiftHRManager.Master" AutoEventWireup="true" CodeBehind="ManageTrainingSummaryReport.aspx.cs" Inherits="SwiftHrManagement.web.Report.Training.ManageTrainingSummaryReport" %>
			...
			<td valign="top">
				<table width="100%" height="30" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<img src="/images/big_bullit.gif">&nbsp;&nbsp;Training Summary Report</td>
					</tr>
					<tr>
...
<!--START FORM STYLE-->
 <table class="container" border="0" cellpadding="0" cellspacing="0" width="30%">
  <tbody><tr>
    ...
    <td width="91%" class="container_tmid"><div>Training Summary Report</div></td>
