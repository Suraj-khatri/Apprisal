...
{
    public partial class TrainingSummaryReport : BasePage
    {
        ...
        private void loadReport()
        {
            ...
            DataTable dt = _trainingSummary.FindTrainingSummaryReport(this.ReadSession().RptQuery).Tables[0];
