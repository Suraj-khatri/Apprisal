...
namespace SwiftHrManagement.web.Report.TrainingRpt
{
    public partial class TnaReport : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            var sql = "EXEC [procRptTNA] @flag='a',@startDate=" + filterstring(startDate) + ",@endDate=" +
                    filterstring(endDate) + ",@branch=" + filterstring(branch) + ",@dept=" + filterstring(dept) + ","
                    + " @emp=" + filterstring(emp) + ",@position=" + filterstring(position) + ",@funTitle="+filterstring(funTitle)+"";
