    ...
    public partial class List : BasePage
    {
        ...
        private void init()
        {
            ...
            String[,] matfilter = new String[,]{  
                        ...
                        {"slm.branch_Code",    "Branch Code",         "LT"},
                        {"sdd.DETAIL_TITLE",    "Head Title",         "LT"},
                        {"slm.ledger_name",    "Ledger Name",         "LT"},
                        {"slm.ledger_number",    "Ledger Number",         "EN"}
            ...
            String[,] matgrid = new String[,]{
                        ...
                        {"branch_Code",            "Branch Code",             "200",      "T"},
                        {"DETAIL_TITLE",       "Head Title",        "200",      "T"},
                        {"ledger_name",       "Ledger Name",        "200",      "T"},
                        {"ledger_number",       "Ledger Number",        "200",      "T"}
                        };



            string sortby = "ID";
            string table_name = "SalaryLeadgerMapping";

            String sql = "";

            sql = @"SELECT slm.ID,isnull(b.BRANCH_NAME,'ALL') BRANCH_NAME,isnull(slm.branch_Code,93) branch_Code,sdd.DETAIL_TITLE,slm.ledger_name,slm.ledger_number 
	               FROM SalaryLeadgerMapping slm 
	               left JOIN Branches b ON b.BRANCH_ID=slm.Branch_ID 
	               INNER JOIN StaticDataDetail sdd ON sdd.ROWID=slm.Head_ID WHERE 1=1";
        ...
        private string load_report(string table_name, string sql, String[,] matgrid, string[,] matfilter, String sortd, string sortby, int _page, int page_size)
        {
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                //html.Append("<td><a href=\"/SalaryLeaderMapping/Manage.aspx?Id=" + dr["Id"] + "\">View</a></td>");
                html.Append("<td class=\"text-center\"><a class=\"tool btn btn-primary btn-xs\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"View\" href=\"/SalaryLeaderMapping/Manage.aspx?Id=" + dr["Id"] + "\"><i class=\"fa fa-eye\"></i></a></td>");
            ...
            string navigation_bar = get_paging_block(total_record, _page, page_size, true, "/SalaryLeaderMapping/Manage.aspx");
