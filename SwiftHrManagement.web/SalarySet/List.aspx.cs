    ...
    public partial class List : BasePage
    {
        ...
        private void init()
        {
            ...
            String[,] matfilter = new String[,]{  
                        {"salaryTitle",          "Salary Title",          "LT"},   
                        {"createddate",          "Created Date",          "D"}                   
                    };

            //column type : T = text , M = Money, D = date , I = image , N = Number
            String[,] matgrid = new String[,]{
                        {"salaryTitle",             "Salary Title",          "200",      "T"},
                        {"Desccription",            "Description",           "200",      "T"},
                        {"No_of_Grades",            "No of Grades",          "200",      "N"},
                        {"createddate",             "Created Date",          "200",      "D"}, 
            ...
            string table_name = "salarySetMaster";

            String sql = "";

            sql = "SELECT salarySetMasterId,s.DETAIL_TITLE salaryTitle,Desccription,No_of_Grades,convert(varchar,createddate,107) createddate FROM salarySetMaster sm inner join StaticDataDetail s on sm.Salary_Title = s.ROWID  where 1=1";
        ...
        private string load_report(string table_name, string sql, String[,] matgrid, string[,] matfilter, String sortd, string sortby, int _page, int page_size)
        {
            ...
            html.Append("<tr Class=\"HeaderStyle\">");
            ...
            //html.Append("<th class=\"text-center\" align=\"center\">Head</th>");
            //html.Append("<th class=\"text-center\" align=\"center\">Setup</th>");
            //html.Append("<th Class=\"HeaderStyle\" align=\"left\">View</th>");
            //html.Append("<th Class=\"HeaderStyle\" align=\"left\">Salary Head</th>");
            //html.Append("<th Class=\"HeaderStyle\" align=\"left\">Grade Setup</th>");
            html.Append("</tr>");
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                html.Append("<td class=\"text-center\"><a class=\"tool btn btn-primary btn-xs\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"View\" href=\"/SalarySet/ManageSalarySet.aspx?MasterId=" + dr["salarySetMasterId"] + "\"><i class=\"fa fa-eye\"></i></a>" +
                            "<a  class=\"tool btn btn-info btn-xs\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Add\" href=\"/SalarySet/ManageSalarySetDetails.aspx?MasterId=" + dr["salarySetMasterId"] + "&SalaryTitle=" + dr["salaryTitle"] + "\"><i class=\"fa fa-plus\"></i></a>" +
                                "<a  class=\"tool btn btn-info btn-xs\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Grade Setup\" href=\"/SalarySet/ManageGradeSetup.aspx?MasterId=" + dr["salarySetMasterId"] + "&SalaryTitle=" + dr["salaryTitle"] + "&Grade=" + dr["No_of_Grades"] + "\"><i class=\"fa fa-plus\"></i></a></td>");
            ...
            string navigation_bar = get_paging_block(total_record, _page, page_size, true, "/SalarySet/ManageSalarySet.aspx");
