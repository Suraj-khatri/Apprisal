<%@ Page Title="" Language="C#" MasterPageFile="~/Apprisal.Master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="SwiftHrManagement.web.StaticView.FiscalMonthSetup.List" %>
   ...
   <table width="100%">
        <tr>
            <td align="left" class="wellcome" valign="bottom">
                <img src="../../Images/big_bullit.gif" />&nbsp;Nepali Calendar Setup Details</td>
        </tr>
        <tr>
