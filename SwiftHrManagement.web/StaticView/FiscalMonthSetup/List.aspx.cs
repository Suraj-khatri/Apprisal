...
#region SwiftGrid
        ...
        private void init()
        {
            ...
            String[,] matfilter = new String[,]{
                        {"nplYear",    "Nepali Year",         "LT"}
                    };
            //column type : T = text , M = Money, D = date , I = image
            String[,] matgrid = new String[,]{
                        {"nplYear",            "Nep. Year",               "200",      "LT"},
                        {"engDateBaisakh",     "Eng.Date Baisakh",        "200",      "LT"},
                        {"baisakh",            "Baisakh",                 "200",      "LT"},
                        {"jestha",             "Jestha",                  "200",      "LT"},
                        {"ashadh",             "Ashad",                   "200",      "LT"},
                        {"shrawan",            "Shrawan",                 "200",      "LT"},
                        {"bhadra",             "Bhadra",                  "200",      "LT"},
                        {"ashwin",             "Ashwin",                  "200",      "LT"},
                        {"kartik",             "kartik",                  "200",      "LT"},
                        {"mangshir",           "Mangshir",                "200",      "LT"},
                        {"poush",              "Poush",                   "200",      "LT"},
                        {"magh",               "Magh",                    "200",      "LT"},
                        {"falgun",             "Falgun",                  "200",      "LT"},
                        {"chaitra",            "Chaitra",                 "200",      "LT"},
                        };
            string sortby = "nplYear";
            string table_name = "Fiscal_Month";

            String sql = "select nplYear, convert(varchar, engDateBaisakh,107) 'engDateBaisakh', baisakh, jestha, ashadh, shrawan, bhadra, ashwin,kartik, mangshir, poush, magh, falgun, chaitra from  Fiscal_Month where 1=1";
