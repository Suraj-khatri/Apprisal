<%@ Page Language="C#" MasterPageFile="~/SwiftHRManager.Master" AutoEventWireup="true" CodeBehind="ActiveProgramList.aspx.cs" Inherits="SwiftHrManagement.web.TrainingManagement.BranchTrainingParticipant.ActiveProgramList" Title="Swift HRM" %>
...
<table width="100%">
                        <tr>
                            <td align="left" class="wellcome" valign="bottom">
                                <img src="../../Images/big_bullit.gif" />&nbsp;&nbsp;Active Program Lists
                            </td>
                        </tr>
                        <tr>
