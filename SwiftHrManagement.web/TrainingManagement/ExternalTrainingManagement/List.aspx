<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/SwiftHRManager.Master" CodeBehind="List.aspx.cs" Inherits="SwiftHrManagement.web.TrainingManagement.ExternalTrainingManagement.List" %>
...
<table width="100%">
                        <tr>
                            <td align="left" class="wellcome" valign="bottom">
                                <img src="../../Images/big_bullit.gif" />&nbsp;External Training Program
                            </td>
                        </tr>
                        <tr>
