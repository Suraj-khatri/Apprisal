<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/SwiftHRManager.Master" CodeBehind="ListAddTraineeParticipant.aspx.cs" Inherits="SwiftHrManagement.web.TrainingManagement.ExternalTrainingManagement.ListAddTraineeParticipant" %>
...
<table width="100%">
                        <tr>
                            <td align="left" class="wellcome" valign="bottom">
                                <img src="../../Images/big_bullit.gif" />&nbsp;Trainee Participant Program
                            </td>
                        </tr>
                        <tr>
