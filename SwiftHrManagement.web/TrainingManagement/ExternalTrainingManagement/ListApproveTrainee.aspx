<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/SwiftHRManager.Master" CodeBehind="ListApproveTrainee.aspx.cs" Inherits="SwiftHrManagement.web.TrainingManagement.ExternalTrainingManagement.ListApproveTrainee" %>
...
<table width="100%">
                        <tr>
                            <td align="left" class="wellcome" valign="bottom">
                                <img src="../../Images/big_bullit.gif" />&nbsp;External Training Program Approve
                            </td>
                        </tr>
                        <tr>
