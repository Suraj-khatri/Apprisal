<%@ Page Language="C#" MasterPageFile="~/SwiftHRManager.Master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="SwiftHrManagement.web.TrainingManagement.TrainingFeedback.List" Title="Swift HRM" %>
...
<table width="100%">
                        <tr>
                            <td align="left" class="wellcome" valign="bottom">
                                <img src="../../Images/big_bullit.gif" />&nbsp;&nbsp;Training Program Feedback Details
                            </td>
                        </tr>
                        <tr>
