<%@ Page Language="C#" MasterPageFile="~/SwiftHRManager.Master" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="SwiftHrManagement.web.TrainingManagement.TrainingNeedAssessment.Modify"%>
    ...
    <tr>
        ...
        <table align="left" border="1" cellspacing="1" cellpadding="5" class="FormDesign">        
            <tr>
                ...
                <td><asp:DropDownList ID="DdlEmpName" runat="server" CssClass="CMBDesign" 
            ...
            <tr>
             ...
             <tr>
                <td>&nbsp;</td>
                <td><div align="right">Immediate Subrdinate :</div></td>
                <td><asp:DropDownList ID="DdlISubName" runat="server" CssClass="CMBDesign"></asp:DropDownList> </td>
                <td><div align="right">Position:</div></td>
                <td><asp:DropDownList ID="DdlISubPosition" runat="server" CssClass="CMBDesign"></asp:DropDownList> </td>
            </tr>
            <tr>
                <th>1.</th>
