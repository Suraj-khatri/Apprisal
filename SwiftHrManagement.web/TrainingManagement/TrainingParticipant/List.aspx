<%@ Page Language="C#" MasterPageFile="~/SwiftHRManager.Master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="SwiftHrManagement.web.TrainingManagement.TrainingParticipant.List" Title="Swift HRM" %>
...
<table width="100%">
        ...
        <img src="/images/big_bullit.gif">Employee Participant Details, Category :  <span class="subheading">
