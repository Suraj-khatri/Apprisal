    ...
    public partial class List : BasePage
    {
        ...
        private void init()
        {
            ...
            String[,] matfilter = new String[,]{                        
                        {"TRAINING_NAME",    "Category Name",         "LT"},  
                        {"COURSE_CONTENTS",    "Course Content",         "LT"}
                    };

            //column type : T = text , M = Money, D = date , I = image
            String[,] matgrid = new String[,]{
                        {"TRAINING_NAME",            "Category Name",             "200",      "T"},
                        {"DESIGNED_FOR",            "Category Designed For",             "200",      "T"},
                        {"COURSE_CONTENTS",       "Course Content",        "200",      "T"}
                        };

            string sortby = "ID";
            string table_name = "TrainingList";

            String sql = "";

            sql = "SELECT ID,TRAINING_NAME,DESIGNED_FOR,COURSE_CONTENTS FROM TrainingList where 1=1";
        ...
        private string load_report(string table_name, string sql, String[,] matgrid, string[,] matfilter, String sortd, string sortby, int _page, int page_size)
        {
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                html.Append("<td class=\"text-center\"><a class=\"tool btn btn-primary btn-xs\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"View\" href=\"/TrainingModule/CATEGORY/Manage.aspx?Id=" + dr["ID"] + "\"><i class=\"fa fa-eye\"></i></a></td>");
                html.Append("</tr>");
            }
            ...
            string navigation_bar = get_paging_block(total_record, _page, page_size, true, "/TrainingModule/CATEGORY/Manage.aspx");
