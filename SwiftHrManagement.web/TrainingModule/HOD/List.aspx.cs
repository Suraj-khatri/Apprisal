    ...
    public partial class List : BasePage
    {
        ...
        private void init()
        {
            ...
            sql = @"select id,programType,programName,convert(varchar,startDate,107) as startDate,convert(varchar,endDate,107) as endDate
                    ,conductedBy,venue,status,dbo.GetEmployeeFullNameOfId(createdBy) createdBy,convert(varchar,createdDate,107) createdDate
        ...
        private string load_report(string table_name, string sql, String[,] matgrid, string[,] matfilter, String sortd, string sortby, int _page, int page_size)
        {
            ...
            string thisPage = "/TrainingModule/HOD/List.aspx?sortd=" + sortd + "&sortby={sortby}";
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                html.Append("<td class=\"text-center\"  style=\"width:160px;\"><a class=\"tool btn btn-primary btn-xs\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"View\" href=\"/TrainingModule/HOD/Manage.aspx?ID=" + dr["ID"] + "\"><i class=\"fa fa-eye\"></i></a><a class=\"tool btn btn-primary btn-xs\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"File\" href=\"/TrainingModule/UPLOAD/Manage.aspx?ID=" + dr["ID"] + "\"><i class=\"fa fa-file-excel-o\"></i></a>");
            ...
            string navigation_bar = get_paging_block(total_record, _page, page_size, true, "/TrainingModule/HOD/Manage.aspx");
