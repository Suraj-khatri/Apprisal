...
{
    public partial class ApproveExtensionList : BasePage
    {
        RoleMenuDAOInv _roleMenuDao = null;
        public ApproveExtensionList()
        {
            this._roleMenuDao=new RoleMenuDAOInv();
        }
        protected void Page_Load(object sender, EventArgs e)
        {
            if (_roleMenuDao.hasAccess(ReadSession().AdminId, 278) == false)
            {
        ...
        private void init(long EmpId)
        {
            ...
            String[,] matgrid = new String[,]{
                        ...
                        {"ExtFromDate",               "Extension_From",                "200",      "D"},                        
                        {"ExtToDate",                 "Extension_To",                  "200",      "D"},
                        {"ExtStatus",               "Extension Status",               "100",              "T"}
            ...
            sql = @"SELECT Distinct
						...
						,CONVERT(VARCHAR,ExtFromDate,107) ExtFromDate
						,CONVERT(VARCHAR,ExtToDate,107) ExtToDate
					...
					WHERE ta.IsExtention='Y' and ta.ExtApproveBy= " +ReadSession().Emp_Id.ToString()+"";
        ...
        private string load_report(string table_name, string sql, String[,] matgrid, string[,] matfilter, String sortd, string sortby, int _page, int page_size)
        {
            ...
            string thisPage = "ApproveExtensonManage.aspx?sortd=" + sortd + "&sortby={sortby}";
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                html.Append("<td class=\"text-center\"><a class=\"tool btn btn-primary btn-xs\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"View\" href=\"/TravelOrder/ApproveExtension/ApproveExtensonManage.aspx?id=" + dr["id"] + "\"><i class=\"fa fa-eye\"></i></a></td>");
                html.Append("</tr>");
            }
