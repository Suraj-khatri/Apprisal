...
<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/SwiftHRManager.Master" CodeBehind="ApprovedRequestList.aspx.cs" Inherits="SwiftHrManagement.web.TravelOrder.ApprovedRequestList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainPlaceHolder" runat="server">
 ...
 <header class="panel-heading">
            <i class="fa fa-user"></i>
                Travel Request Details For Verification
                            </header>
