...
{
    public partial class ManageReimbursement : BasePage
    {
        clsDAO CLsDAo = null;
        RoleMenuDAOInv _roleMenuDao = null;
        private SalarySetDao _salarySetDao = null;
        public ManageReimbursement()
        {
        ...
        //    string emp_id = getEmpIdfromInfo(LblEmpName.Text);
        //    DataTable dt = _salarySetDao.FindEmpInfo(emp_id); 
        //    DataRow dr = null;
        ...
        //    txtDesignation.Text = dr["DETAIL_TITLE"].ToString();
        ...
        {
            if (this.DropDownList10.Text == "Yes")
            {
