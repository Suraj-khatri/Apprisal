<%@ Page Title="" Language="C#" MasterPageFile="~/SwiftHRManager.Master" AutoEventWireup="true" CodeBehind="ManageRequestAll.aspx.cs" Inherits="SwiftHrManagement.web.TravelOrder.ManageRequestAll" %>
    ...
    <asp:UpdatePanel runat="server" ID="pnl1">
        <ContentTemplate>
            ...
            Travel Authorization Form All
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 form-group">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server"
                                ...
                                SetFocusOnError="True" />
                            <asp:DropDownList ID="Ddlmode" runat="server" CssClass="form-control" OnSelectedIndexChanged="Ddlmode_SelectedIndexChanged1"
                                AutoPostBack="true" />
                        </div>
                     ...
                     <div id="divFlightDetails" runat="server" visible="true">
                    <div class="row">
                            <div class="col-md-12 form-group">
                    ...
                    <div class="row">
                        <div class="col-md-12 form-group">
                            <asp:UpdatePanel ID="ccList" runat="server">
                                <ContentTemplate>
                                    <iframe id="notificationList" src="../../../cc/cc.aspx"
                                        frameborder="0" scrolling="auto" width="400"></iframe>
                                </ContentTemplate>
                            </asp:UpdatePanel>
                        </div>
                    </div>
                    ...
                    <div class="row">
                            ...
                            <div class="col-md-4 form-group">
                                <label>&nbsp;</label><br />
                                <asp:Button ID="btnAddCurrency" runat="server" CssClass="btn btn-primary" Text="Add"
                                    OnClick="btnAddCurrency_Click" />
                            </div>
                        </div>
                        <div id="rpt2" class="col-md-12 form-group" runat="server">
                        </div>
                    </div>
            <div class="row">
            ...
            <asp:Button ID="BtnSave" runat="server" CssClass="btn btn-primary"
                OnClick="BtnSave_Click" Text="Save" ValidationGroup="tada" />
