...
{
    public partial class ListTicketPersonal : BasePage
    {
        ...
        private string load_report(string table_name, string sql, String[,] matgrid, string[,] matfilter, String sortd, string sortby, int _page, int page_size)
        {
            ...
            string thisPage = "ListTicketPersonal.aspx?sortd=" + sortd + "&sortby={sortby}&ID=" + GetTypeId() + "";
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                html.Append("<td class=\"text-center\"><a class=\"tool btn btn-primary btn-xs\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"View\" href=\"ManageTicketPersonal.aspx?ID=" + dr["ID"] + "\"><i class=\"fa fa-eye\"></i></a></td>");

                //html.Append("<td><a href=\"ManageTicketPersonal.aspx?ID=" + dr["ID"] + "\">View</a></td>");
                html.Append("</tr>");
            }
            ...
            string navigation_bar = get_paging_block(total_record, _page, page_size, true, "ManageTicketPersonal.aspx?TypeID=" + GetTypeId() + "");
