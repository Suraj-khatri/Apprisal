<%@ Page Language="C#" MasterPageFile="~/SwiftHRManager.Master" AutoEventWireup="true" CodeBehind="BidForProductList.aspx.cs" Inherits="SwiftHrManagement.web.Vendor.BidForProductList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainPlaceHolder" runat="server">
    <div class="panel">
        <header class="panel-heading">
            Vendor Bid For Product Details
        </header>
    ...
    <table width="100%">                        
            <tr>
                <td align="left" class="wellcome" valign="bottom">
                    <img src="../../Images/big_bullit.gif" />&nbsp;Vendor Bid For Product Details
                </td>
            </tr>
            <tr>
