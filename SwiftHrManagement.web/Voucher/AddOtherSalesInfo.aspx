<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddOtherSalesInfo.aspx.cs" Inherits="SwiftHrManagement.web.Voucher.AddOtherSalesInfo" %>
...
<tr>
    ...
    <fieldset style="list-style:circle; list-style-type:circle; width:98%;"><legend class="style2">
        ...
        <div>        
            ...
            <tr>
                <td colspan="5"><div id="rpt" runat="server"></div></td>
            </tr>
             <tr>
