<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/SwiftHRManager.Master" CodeBehind="ListPurchaseOrderReceived.aspx.cs" Inherits="SwiftHrManagement.web.Voucher.ListPurchaseOrderReceived" %>
...
<%--<table width="100%">
        <tr>
            <td align="left" class="wellcome" valign="bottom">
                <img src="/Images/big_bullit.gif" />&nbsp;Purchase Order Received Details
            </td>
        </tr>
        <tr>
    ...
    <div class="panel">
        <header class="panel-heading">
          ...
          Purchase Order Received Details
        </header>
