<%@ Page Language="C#" MasterPageFile="~/SwiftHRManager.Master" AutoEventWireup="true" CodeBehind="PurchaseReturnVoucher.aspx.cs" Inherits="SwiftAssetManagement.Voucher.PurchaseReturnVoucher" %>
			...
			<td valign="top">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<img src="/images/spacer.gif" width="5" height="1"><img src="/images/big_bullit.gif">&nbsp;Purchase Return Voucher Entry</td>
					</tr>
					<tr>
 ...
 <table class="container" border="0" cellpadding="0" cellspacing="0" width="20%">
  <tbody>
    <tr>
        ...
        <td width="91%" class="container_tmid"><div>Purchase Return Voucher Entry</div></td>
