...
{
    public partial class PurchaseReturnVoucher : BasePage
    {
        String DelProduct = "";
        String DelAccount = "";
        ClsDAOInv _clsdao = null;
        RoleMenuDAOInv _RoleMenuDAOInv = null;
        public PurchaseReturnVoucher()
        {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (_RoleMenuDAOInv.hasAccess(ReadSession().AdminId, 116) == false)
                {
        ...
        private void ManageTempPurchase1()
        {
            ...
            _clsdao.runSQL("Exec [procSavePurchaseReturnVoucher] 'i'," + filterstring(product_id) + "," + filterstring(qty.Text) + "," + filterstring(unitprice.Text) + "," + filterstring(amount.Text) + ","
