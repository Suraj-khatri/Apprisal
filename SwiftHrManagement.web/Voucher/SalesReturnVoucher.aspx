<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SalesReturnVoucher.aspx.cs" Inherits="SwiftAssetManagement.Voucher.SalesReturnVoucher" %>
			...
			<td valign="top">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<img src="/images/spacer.gif" width="5" height="1"><img src="/images/big_bullit.gif">&nbsp;Sales Return Voucher Entry</td>
					</tr>
					<tr>
 ...
 <table class="container" border="0" cellpadding="0" cellspacing="0" width="20%">
  <tbody>
    <tr>
        ...
        <td width="91%" class="container_tmid"><div>Sales Return Voucher Entry</div></td>
...
<tr>
    <td>Check For Without VAT Purchase 
...
<tr>
    ...
    <fieldset style="list-style:circle; list-style-type:circle; width:98%;"><legend class="style2">Product / Account Information:</legend>    
        <div>        
            ...
            <tr>
                <td colspan="6"><div id="rpt" runat="server">
                    <label>
                    <asp:Button ID="BtnAddAcc" runat="server" CssClass="button" 
                        onclick="BtnAddAcc_Click" Text=" Add " ValidationGroup="addaccount" />
                    </label>
                    </div></td>
            </tr>
             <tr>
             ...
             <tr>
                <td colspan="5"><div align="right">
                    <asp:Button ID="BtnDeleteAcc" runat="server" Text="Delete" CssClass="button" 
                        onclick="BtnDeleteAcc_Click"/></div></td>
            </tr>
