<%@ Page Language="C#" MasterPageFile="~/SwiftHRManager.Master" AutoEventWireup="true" CodeBehind="CustomerList.aspx.cs" Inherits="SwiftHrManagement.web.WorkFlowManagement.Customer.CustomerList" %>
...
<table width="100%">                        
                        <tr>
                            <td align="left" class="wellcome" valign="bottom">
                                <img src="../../Images/big_bullit.gif" />&nbsp;Customer Information Details
                            </td>
                        </tr>
                        <tr>
