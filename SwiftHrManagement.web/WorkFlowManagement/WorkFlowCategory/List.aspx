<%@ Page Language="C#" MasterPageFile="~/SwiftHRManager.Master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="SwiftHrManagement.web.WorkFlowManagement.WorkFlowCategory.List" Title="Swift HR Management System 1.0" %>
...
<table width="100%">                        
                        <tr>
                            <td align="left" class="wellcome" valign="bottom">
                                <img src="../../Images/big_bullit.gif" />&nbsp;Job Category Details
                            </td>
                        </tr>
                        <tr>
