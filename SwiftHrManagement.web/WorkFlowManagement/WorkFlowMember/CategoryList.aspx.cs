...
namespace SwiftHrManagement.web.WorkFlowManagement.WorkFlowMember
{
    public partial class CategoryList : BasePage
    {
        ...
        private string load_report(string table_name, string sql, String[,] matgrid, string[,] matfilter, String sortd, string sortby, int _page, int page_size)
        {
            ...
            string thisPage = "CategoryList.aspx?sortd=" + sortd + "&sortby={sortby}";
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                html.Append("<td><a href=\"/WorkFlowManagement/WorkFlowMember/MemberList.aspx?Id=" + dr["WF_CATEGORYID"] + "\">Members</a></td>");
                html.Append("</tr>");
            }
